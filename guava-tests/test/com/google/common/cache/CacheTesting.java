...
begin_comment
comment|/**  * A collection of utilities for {@link Cache} testing.  *  * @author schmoe@google.com (mike nonemacher)  */
end_comment
...
return|;
block|}
DECL|method|expirationQueueSize (Segment<?, ?> segment)
specifier|static
name|int
name|expirationQueueSize
parameter_list|(
...
return|;
block|}
DECL|method|evictionQueueSize (Cache<?, ?> cache)
specifier|static
name|int
...
return|;
block|}
DECL|method|evictionQueueSize (Segment<?, ?> segment)
specifier|static
name|int
name|evictionQueueSize
parameter_list|(
