...
name|TestCase
block|{
DECL|class|TestStringCacheGenerator
specifier|private
specifier|static
class|class
name|TestStringCacheGenerator
extends|extends
name|TestStringMapGenerator
block|{
DECL|field|builder
...
name|builder
decl_stmt|;
DECL|method|TestStringCacheGenerator (CacheBuilder<? super String, ? super String> builder)
name|TestStringCacheGenerator
parameter_list|(
name|CacheBuilder
argument_list|<
...
name|named
argument_list|(
literal|"LocalCache with defaults"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"LocalCache with concurrencyLevel[1]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"LocalCache with maximumSize"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"LocalCache with maximumWeight"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"LocalCache with weakKeys"
argument_list|)
comment|// keys are string literals and won't be GC'd
operator|.
name|withFeatures
argument_list|(
name|CollectionSize
...
name|named
argument_list|(
literal|"LocalCache with weakValues"
argument_list|)
comment|// values are string literals and won't be GC'd
operator|.
name|withFeatures
argument_list|(
name|CollectionSize
...
name|named
argument_list|(
literal|"LocalCache with softValues"
argument_list|)
comment|// values are string literals and won't be GC'd
operator|.
name|withFeatures
...
name|named
argument_list|(
literal|"LocalCache with expireAfterAccess"
argument_list|)
comment|// SerializableTicker never advances
operator|.
name|withFeatures
argument_list|(
name|CollectionSize
...
name|named
argument_list|(
literal|"LocalCache with expireAfterWrite"
argument_list|)
comment|// SerializableTicker never advances
operator|.
name|withFeatures
...
name|named
argument_list|(
literal|"LocalCache with removalListener"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"LocalCache with recordStats"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
expr_stmt|;
block|}
DECL|method|checkLogged (Throwable t)
specifier|private
name|void
name|checkLogged
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|makeLocalCache ( CacheBuilder<? super K, ? super V> builder)
specifier|private
specifier|static
parameter_list|<
name|K
...
expr_stmt|;
block|}
DECL|method|checkStrength ( LocalCache<Object, Object> map, Strength keyStrength, Strength valueStrength)
specifier|private
specifier|static
name|void
name|checkStrength
...
expr_stmt|;
block|}
DECL|method|testEntryFactory ()
specifier|public
name|void
name|testEntryFactory
parameter_list|()
block|{
name|assertSame
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testComputeIfAbsent_RemovalListener ()
specifier|public
name|void
name|testComputeIfAbsent_RemovalListener
parameter_list|()
block|{
name|List
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testRemovalListenerCheckedException ()
specifier|public
name|void
name|testRemovalListenerCheckedException
parameter_list|()
block|{
specifier|final
name|RuntimeException
...
expr_stmt|;
block|}
DECL|method|testSegmentRefresh_duplicate ()
specifier|public
name|void
name|testSegmentRefresh_duplicate
parameter_list|()
throws|throws
name|ExecutionException
block|{
...
block|}
block|}
DECL|method|assertConnected ( LocalCache<K, V> map, ReferenceEntry<K, V> one, ReferenceEntry<K, V> two)
specifier|private
specifier|static
parameter_list|<
name|K
...
block|}
block|}
DECL|method|testSegmentStoreComputedValue ()
specifier|public
name|void
name|testSegmentStoreComputedValue
parameter_list|()
block|{
name|QueuingRemovalListener
argument_list|<
...
block|}
block|}
DECL|method|testGetCausesExpansion ()
specifier|public
name|void
name|testGetCausesExpansion
parameter_list|()
throws|throws
name|ExecutionException
block|{
...
expr_stmt|;
block|}
DECL|method|testPutCausesExpansion ()
specifier|public
name|void
name|testPutCausesExpansion
parameter_list|()
block|{
for|for
control|(
...
expr_stmt|;
block|}
DECL|method|testRemoveEntryFromChain ()
specifier|public
name|void
...
block|}
block|}
DECL|method|testRemoveIfWithConcurrentModification ()
specifier|public
name|void
name|testRemoveIfWithConcurrentModification
parameter_list|()
block|{
name|LocalCache
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testRemoveIfWithConcurrentRemoval ()
specifier|public
name|void
name|testRemoveIfWithConcurrentRemoval
parameter_list|()
block|{
name|LocalCache
argument_list|<
...
expr_stmt|;
block|}
DECL|method|countLiveEntries (LocalCache<K, V> map, long now)
specifier|private
specifier|static
parameter_list|<
name|K
...
expr_stmt|;
block|}
DECL|method|testClear_notification ()
specifier|public
name|void
name|testClear_notification
parameter_list|()
block|{
name|QueuingRemovalListener
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testRemoveComputingValue ()
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|// no notification sent with removeLoadingValue
name|assertTrue
argument_list|(
name|map
operator|.
...
expr_stmt|;
block|}
DECL|method|assertNotificationEnqueued ( LocalCache<K, V> map, K key, V value, int hash)
specifier|private
specifier|static
parameter_list|<
name|K
...
block|}
block|}
DECL|method|checkExpirationTimes (LocalCache<K, V> map)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
expr_stmt|;
block|}
DECL|method|testSerializationProxyLoading ()
specifier|public
name|void
name|testSerializationProxyLoading
parameter_list|()
block|{
name|CacheLoader
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// serialize the reconstituted version to be sure we haven't lost the ability to reserialize
name|LocalLoadingCache
argument_list|<
name|Object
argument_list|,
...
expr_stmt|;
block|}
DECL|method|testSerializationProxyManual ()
specifier|public
name|void
name|testSerializationProxyManual
parameter_list|()
block|{
name|RemovalListener
argument_list|<
