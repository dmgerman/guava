...
expr_stmt|;
block|}
DECL|method|testOfPrimitiveDoubleStream ()
specifier|public
name|void
name|testOfPrimitiveDoubleStream
parameter_list|()
block|{
name|Stats
name|stats
...
expr_stmt|;
block|}
DECL|method|testOfPrimitiveIntStream ()
specifier|public
name|void
name|testOfPrimitiveIntStream
parameter_list|()
block|{
name|Stats
name|stats
...
expr_stmt|;
block|}
DECL|method|testOfPrimitiveLongStream ()
specifier|public
name|void
name|testOfPrimitiveLongStream
parameter_list|()
block|{
name|Stats
name|stats
...
expr_stmt|;
block|}
DECL|method|testBoxedDoubleStreamToStats ()
specifier|public
name|void
name|testBoxedDoubleStreamToStats
parameter_list|()
block|{
name|Stats
name|stats
...
expr_stmt|;
block|}
DECL|method|testBoxedBigDecimalStreamToStats ()
specifier|public
name|void
name|testBoxedBigDecimalStreamToStats
parameter_list|()
block|{
name|Stats
name|stats
...
block|{     }
block|}
DECL|method|testEquivalentStreams ()
specifier|public
name|void
name|testEquivalentStreams
parameter_list|()
block|{
comment|// For datasets of many double values created from an array, we test many combinations of finite
comment|// and non-finite values:
...
argument_list|)
decl_stmt|;
comment|// instance methods on Stats vs on instance methods on DoubleStream
name|assertThat
argument_list|(
name|stats
operator|.
...
argument_list|)
expr_stmt|;
comment|// static method on Stats vs on instance method on DoubleStream
name|assertEquivalent
argument_list|(
name|Stats
operator|.
...
argument_list|)
expr_stmt|;
comment|// instance methods on Stats vs instance methods on DoubleSummaryStatistics
name|DoubleSummaryStatistics
name|streamStats
init|=
name|stream
...
block|}
block|}
DECL|method|assertEquivalent (double actual, double expected)
specifier|private
specifier|static
name|void
name|assertEquivalent
