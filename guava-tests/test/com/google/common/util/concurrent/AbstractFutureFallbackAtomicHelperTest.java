...
specifier|final
name|ClassLoader
name|NO_ATOMIC_REFERENCE_FIELD_UPDATER
init|=
name|getClassLoader
argument_list|(
name|ImmutableSet
...
parameter_list|()
block|{
comment|// we create a test suite containing a test for every AbstractFutureTest test method and we
comment|// set it as the name of the test.  Then in runTest we can reflectively load and invoke the
comment|// corresponding method on AbstractFutureTest in the correct classloader.
name|TestSuite
name|suite
init|=
operator|new
