...
expr_stmt|;
block|}
DECL|method|testServiceStartupDurations ()
specifier|public
name|void
name|testServiceStartupDurations
parameter_list|()
block|{
name|Service
name|a
...
expr_stmt|;
block|}
DECL|method|testServiceStartupTimes_selfStartingServices ()
specifier|public
name|void
name|testServiceStartupTimes_selfStartingServices
parameter_list|()
block|{
comment|// This tests to ensure that:
comment|// 1. service times are accurate when the service is started by the manager
comment|// 2. service times are recorded when the service is not started by the manager (but they may
comment|// not be accurate).
specifier|final
name|Service
name|b
init|=
...
expr_stmt|;
block|}
DECL|method|testDoCancelStart ()
specifier|public
name|void
name|testDoCancelStart
parameter_list|()
throws|throws
name|TimeoutException
block|{
...
expr_stmt|;
block|}
DECL|method|testNotifyStoppedAfterFailure ()
specifier|public
name|void
name|testNotifyStoppedAfterFailure
parameter_list|()
throws|throws
name|TimeoutException
block|{
