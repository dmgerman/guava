...
begin_comment
comment|/** Determines whether the given method is time-based. */
end_comment
...
block|{
return|return
name|isLongTimeUnitBased
argument_list|(
name|method
argument_list|)
operator|||
name|isDurationBased
argument_list|(
name|method
argument_list|)
return|;
...
begin_function
DECL|method|isLongTimeUnitBased (Method method)
specifier|private
specifier|static
name|boolean
name|isLongTimeUnitBased
...
begin_comment
comment|/** Determines whether the given method takes a Duration as its last parameter. */
end_comment

begin_function
DECL|method|isDurationBased (Method method)
specifier|private
specifier|static
name|boolean
name|isDurationBased
...
expr_stmt|;
block|}
comment|// we can't make an assumption about isTimed() because now we have single-parameter methods
comment|// that accept a java.time.Duration
name|assertFalse
argument_list|(
name|desc
argument_list|,
