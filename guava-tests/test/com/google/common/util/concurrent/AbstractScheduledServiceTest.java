...
expr_stmt|;
block|}
DECL|method|testFailOnErrorFromStartUpListener ()
specifier|public
name|void
name|testFailOnErrorFromStartUpListener
parameter_list|()
throws|throws
...
expr_stmt|;
block|}
DECL|method|testDefaultExecutorIsShutdownWhenServiceIsStopped ()
specifier|public
name|void
name|testDefaultExecutorIsShutdownWhenServiceIsStopped
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDefaultExecutorIsShutdownWhenServiceFails ()
specifier|public
name|void
name|testDefaultExecutorIsShutdownWhenServiceFails
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Expected service to fail during startup"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
expr_stmt|;
block|}
DECL|class|ThrowingScheduledFuture
specifier|private
specifier|static
specifier|final
class|class
...
argument_list|(
literal|"test should not care about this"
argument_list|)
throw|;
block|}
annotation|@
...
block|}
block|}
DECL|method|testFixedDelayScheduleFarFuturePotentiallyOverflowingScheduleIsNeverReached ()
specifier|public
name|void
name|testFixedDelayScheduleFarFuturePotentiallyOverflowingScheduleIsNeverReached
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testCustomSchedulerFarFuturePotentiallyOverflowingScheduleIsNeverReached ()
specifier|public
name|void
name|testCustomSchedulerFarFuturePotentiallyOverflowingScheduleIsNeverReached
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testCustomScheduler_deadlock ()
specifier|public
name|void
name|testCustomScheduler_deadlock
parameter_list|()
throws|throws
name|InterruptedException
throws|,
...
argument_list|)
decl_stmt|;
comment|// This will flakily deadlock, so run it multiple times to increase the flake likelihood
for|for
control|(
name|int
name|i
