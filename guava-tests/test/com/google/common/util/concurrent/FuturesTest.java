...
expr_stmt|;
block|}
DECL|method|testTransform_inputCancelButNotInterruptPropagatesToOutput ()
specifier|public
name|void
name|testTransform_inputCancelButNotInterruptPropagatesToOutput
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
comment|// This is an evil way to accomplish this, but it works currently.
name|AbstractFuture
argument_list|<
name|Object
argument_list|>
