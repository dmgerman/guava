...
begin_comment
comment|/**  * Unit tests for {@link Futures}.  *  * TODO: Add tests for other Futures methods  *  * @author Nishant Thakkar  */
end_comment
...
specifier|public
name|void
name|testTransform_Future_genericsNull
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testTransformValueRemainsMemoized_Future
parameter_list|()
throws|throws
name|Throwable
block|{
...
specifier|public
name|void
name|testTransformExceptionRemainsMemoized_Future
parameter_list|()
throws|throws
name|Throwable
block|{
...
parameter_list|)
block|{
comment|/*        * The ListenableFuture variant rethrows errors from execute() as well        * as assigning them to the output of the future.        */
block|}
name|runGetIdempotencyTest
argument_list|(
name|exceptionComposedFuture
...
specifier|public
name|void
name|testTransform_Future_genericsHierarchy
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testChain_genericsWildcard ()
specifier|public
name|void
name|testChain_genericsWildcard
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|testChain_genericsHierarchy ()
specifier|public
name|void
name|testChain_genericsHierarchy
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testChain_delegatesBlockingGet ()
specifier|public
name|void
name|testChain_delegatesBlockingGet
parameter_list|()
throws|throws
name|Exception
block|{
name|performChainedFutureDelgationTest
argument_list|(
literal|0
argument_list|,
literal|null
...
expr_stmt|;
block|}
DECL|method|testChain_delegatesTimedGet ()
specifier|public
name|void
name|testChain_delegatesTimedGet
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|performChainedFutureDelgationTest (long timeout, TimeUnit unit)
specifier|private
name|void
name|performChainedFutureDelgationTest
parameter_list|(
...
argument_list|()
decl_stmt|;
name|MockRequiresGetCallFuture
argument_list|<
name|Foo
argument_list|>
name|fooFuture
...
expr_stmt|;
block|}
DECL|method|testTransform_delegatesBlockingGet_AsyncFunction ()
specifier|public
name|void
name|testTransform_delegatesBlockingGet_AsyncFunction
parameter_list|()
throws|throws
name|Exception
block|{
name|performAsyncFunctionTransformedFutureDelgationTest
argument_list|(
literal|0
argument_list|,
literal|null
...
expr_stmt|;
block|}
DECL|method|testTransform_delegatesTimedGet_AsyncFunction ()
specifier|public
name|void
name|testTransform_delegatesTimedGet_AsyncFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|performAsyncFunctionTransformedFutureDelgationTest ( long timeout, TimeUnit unit)
specifier|private
name|void
name|performAsyncFunctionTransformedFutureDelgationTest
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * A mock listenable future that requires the caller invoke    * either form of get() before the future will make its value    * available or invoke listeners.    */
DECL|class|MockRequiresGetCallFuture
specifier|private
specifier|static
class|class
name|MockRequiresGetCallFuture
...
name|value
decl_stmt|;
DECL|field|getWasCalled
specifier|private
name|boolean
name|getWasCalled
decl_stmt|;
DECL|method|MockRequiresGetCallFuture (T value)
name|MockRequiresGetCallFuture
parameter_list|(
name|T
name|value
...
block|}
block|}
DECL|method|testAllAsList_buggyInputFutures ()
specifier|public
name|void
name|testAllAsList_buggyInputFutures
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSuccessfulAsList_buggyInputFutures ()
specifier|public
name|void
name|testSuccessfulAsList_buggyInputFutures
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|/*    * We can't write "= immediateFailedFuture(ERROR)" because setException    * rethrows the error....    */
static|static
block|{
name|SettableFuture
argument_list|<
