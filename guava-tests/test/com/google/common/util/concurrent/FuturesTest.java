...
specifier|public
name|void
name|testAllAsList_logging_seenExceptionUpdateRaceBuggy
parameter_list|()
throws|throws
name|Exception
block|{
...
parameter_list|()
block|{
comment|/*          * firstFuture just completed, but AggregateFuture hasn't yet had time to record the          * exception in seenExceptions. When we complete secondFuture with the same exception,          * AggregateFuture will think that it's new.          */
name|secondFuture
operator|.
name|setException
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO(cpovirk): Fix this bug. We should see 0 records:
name|assertEquals
argument_list|(
literal|1
argument_list|,
