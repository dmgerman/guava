...
DECL|method|testWithTimeout_timerWriteNotVisibleToScheduledTask ()
specifier|public
name|void
name|testWithTimeout_timerWriteNotVisibleToScheduledTask
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// should complete when the timer task notices that the delegate is done.
name|timeoutFuture
operator|.
name|get
argument_list|(
