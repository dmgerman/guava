...
expr_stmt|;
block|}
comment|/**    * This tests for a bug where if {@link Service#stop()} was called while the service was    * {@link State#STARTING} more than once, the {@link Listener#stopping(State)} callback would get    * called multiple times.    */
...
expr_stmt|;
block|}
DECL|method|testFailingServiceStopAndWait_runFailinging ()
specifier|public
name|void
name|testFailingServiceStopAndWait_runFailinging
parameter_list|()
throws|throws
name|Exception
block|{
...
parameter_list|()
block|{
comment|// Internally start() grabs a lock, this could be any such method on AbstractService.
name|service
operator|.
name|start
argument_list|()
