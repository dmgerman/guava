...
expr_stmt|;
block|}
DECL|method|testGetFailure_throwsIfNotFailed ()
specifier|public
name|void
name|testGetFailure_throwsIfNotFailed
parameter_list|()
block|{
name|StopThrowingService
name|service
...
parameter_list|()
block|{
comment|// Internally state() grabs a lock, this could be any such method on AbstractService.
name|service
operator|.
name|state
argument_list|()
