...
expr_stmt|;
block|}
DECL|method|testSimpleAcquireEarliestAvailableIsInPast ()
specifier|public
name|void
name|testSimpleAcquireEarliestAvailableIsInPast
parameter_list|()
block|{
name|RateLimiter
name|limiter
...
literal|"R0.00"
argument_list|,
comment|// First comes the saved-up burst, which defaults to a 1-second burst (2 requests).
literal|"R0.00"
argument_list|,
literal|"R0.00"
argument_list|,
comment|// Now comes the free request.
literal|"R0.50"
argument_list|,
comment|// Now it's 0.5 seconds per request.
literal|"R0.50"
argument_list|)
expr_stmt|;
name|limiter
...
argument_list|)
expr_stmt|;
comment|// we repay the last request (.5sec), then back to +oo
block|}
comment|/** https://code.google.com/p/guava-libraries/issues/detail?id=1791 */
DECL|method|testInfinity_BustyTimeElapsed ()
specifier|public
name|void
name|testInfinity_BustyTimeElapsed
parameter_list|()
block|{
name|RateLimiter
name|limiter
...
expr_stmt|;
block|}
DECL|method|testInfinity_WarmUpTimeElapsed ()
specifier|public
name|void
name|testInfinity_WarmUpTimeElapsed
parameter_list|()
block|{
name|RateLimiter
name|limiter
