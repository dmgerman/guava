...
argument_list|)
decl_stmt|;
comment|/**    * Having a public suffix is equivalent to having a registry suffix, because all registry suffixes    * are public suffixes, and all public suffixes have registry suffixes.    */
DECL|field|NO_RS
specifier|private
specifier|static
specifier|final
...
literal|"foo.bar.ca"
argument_list|,
literal|"foo.blogspot.com"
argument_list|,
literal|"foo.blogspot.co.uk"
argument_list|,
literal|"foo.uk.com"
argument_list|,
...
argument_list|()
decl_stmt|;
DECL|field|TOP_UNDER_REGISTRY_SUFFIX
specifier|private
specifier|static
specifier|final
name|ImmutableSet
...
name|String
argument_list|>
name|TOP_UNDER_REGISTRY_SUFFIX
init|=
name|ImmutableSet
operator|.
name|of
...
argument_list|)
decl_stmt|;
DECL|field|UNDER_TOP_UNDER_REGISTRY_SUFFIX
specifier|private
specifier|static
specifier|final
name|ImmutableSet
...
name|String
argument_list|>
name|UNDER_TOP_UNDER_REGISTRY_SUFFIX
init|=
name|ImmutableSet
operator|.
name|of
