...
expr_stmt|;
block|}
DECL|method|testForStringIPv4NonAsciiInput ()
specifier|public
name|void
name|testForStringIPv4NonAsciiInput
parameter_list|()
throws|throws
name|UnknownHostException
block|{
...
decl_stmt|;
comment|// 192.168.0.1 in Gujarati digits
comment|// Shouldn't hit DNS, because it's an IP string literal.
name|InetAddress
name|ipv4Addr
decl_stmt|;
...
parameter_list|)
block|{
comment|// OK: this is probably Android, which is stricter.
return|return;
block|}
name|assertEquals
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testForStringIPv6NonAsciiInput ()
specifier|public
name|void
name|testForStringIPv6NonAsciiInput
parameter_list|()
throws|throws
name|UnknownHostException
block|{
...
literal|"à«©ffe::à«§"
decl_stmt|;
comment|// 3ffe::1 with Gujarati digits for 3 and 1
comment|// Shouldn't hit DNS, because it's an IP string literal.
name|InetAddress
name|ipv6Addr
decl_stmt|;
