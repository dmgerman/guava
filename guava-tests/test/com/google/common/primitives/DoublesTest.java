...
expr_stmt|;
block|}
DECL|method|testReverse (double[] input, double[] expectedOutput)
specifier|private
specifier|static
name|void
name|testReverse
...
expr_stmt|;
block|}
DECL|method|testReverse ( double[] input, int fromIndex, int toIndex, double[] expectedOutput)
specifier|private
specifier|static
name|void
name|testReverse
...
block|}
block|}
DECL|method|testSortDescending ( double[] input, int fromIndex, int toIndex, double[] expectedOutput)
specifier|private
specifier|static
name|void
name|testSortDescending
...
condition|)
block|{
comment|// TODO(cpovirk): Use SourceCodeEscapers if it is added to Guava.
name|StringBuilder
name|escapedInput
init|=
operator|new
...
name|fail
argument_list|(
literal|"FLOATING_POINT_PATTERN should have matched valid input<"
operator|+
name|escapedInput
operator|+
literal|">"
