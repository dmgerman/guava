...
expr_stmt|;
block|}
comment|// TODO(kevinb): go up to 13ish...
...
return|;
block|}
DECL|method|doIt (ImmutableIntArray.Builder builder, AtomicInteger counter)
specifier|abstract
name|void
name|doIt
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|assertActuallyTrims (ImmutableIntArray iia)
specifier|private
specifier|static
name|void
name|assertActuallyTrims
...
expr_stmt|;
block|}
DECL|method|assertDoesntActuallyTrim (ImmutableIntArray iia)
specifier|private
specifier|static
name|void
name|assertDoesntActuallyTrim
...
argument_list|(
operator|new
name|ImmutableIntArrayAsListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"ImmutableIntArray.asList"
argument_list|)
argument_list|,
name|ListTestSuiteBuilder
operator|.
...
argument_list|(
operator|new
name|ImmutableIntArrayHeadSubListAsListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"ImmutableIntArray.asList, head subList"
argument_list|)
argument_list|,
name|ListTestSuiteBuilder
operator|.
...
argument_list|(
operator|new
name|ImmutableIntArrayTailSubListAsListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"ImmutableIntArray.asList, tail subList"
argument_list|)
argument_list|,
name|ListTestSuiteBuilder
operator|.
...
argument_list|(
operator|new
name|ImmutableIntArrayMiddleSubListAsListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"ImmutableIntArray.asList, middle subList"
argument_list|)
argument_list|)
decl_stmt|;
name|TestSuite
