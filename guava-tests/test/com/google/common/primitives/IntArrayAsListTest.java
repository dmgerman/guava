...
begin_comment
comment|/**  * Test suite covering {@link Ints#asList(int[])}.  *  * @author Kevin Bourrillion  */
end_comment
...
specifier|public
class|class
name|IntArrayAsListTest
extends|extends
name|TestCase
block|{
DECL|method|asList (Integer[] values)
specifier|private
specifier|static
name|List
argument_list|<
...
argument_list|(
operator|new
name|IntsAsListHeadSubListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"Ints.asList, head subList"
argument_list|)
argument_list|,
name|ListTestSuiteBuilder
operator|.
...
argument_list|(
operator|new
name|IntsAsListTailSubListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"Ints.asList, tail subList"
argument_list|)
argument_list|,
name|ListTestSuiteBuilder
operator|.
...
argument_list|(
operator|new
name|IntsAsListMiddleSubListGenerator
argument_list|()
argument_list|)
operator|.
name|named
argument_list|(
literal|"Ints.asList, middle subList"
argument_list|)
argument_list|)
decl_stmt|;
name|TestSuite
...
DECL|class|IntsAsListGenerator
specifier|public
specifier|static
specifier|final
class|class
...
block|}
block|}
DECL|class|IntsAsListHeadSubListGenerator
specifier|public
specifier|static
specifier|final
class|class
...
block|}
block|}
DECL|class|IntsAsListTailSubListGenerator
specifier|public
specifier|static
specifier|final
class|class
...
block|}
block|}
DECL|class|IntsAsListMiddleSubListGenerator
specifier|public
specifier|static
specifier|final
class|class
...
block|}
block|}
DECL|method|concat (Integer[] left, Integer[] right)
specifier|private
specifier|static
name|Integer
index|[]
