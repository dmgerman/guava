...
decl_stmt|;
comment|/**    * A SecurityManager that disallows {@link java.lang.reflect.Method#setAccessible(boolean)}    * except when it comes from one of a set of known classes. The purpose is to detect whether we    * do a setAccessible call that might fail in a context where a SecurityManager forbids it.    */
...
argument_list|,
literal|"EqualsTester"
argument_list|,
literal|"ObjectStreamClass"
argument_list|)
decl_stmt|;
annotation|@
name|Override
