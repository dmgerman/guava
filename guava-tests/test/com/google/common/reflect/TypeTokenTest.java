...
argument_list|)
expr_stmt|;
name|assertRawTypesInSameOrder
argument_list|(
name|types
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|assertRawTypesInSameOrder (TypeToken<?>.TypeSet types)
specifier|private
specifier|static
name|void
name|assertRawTypesInSameOrder
...
block|}
block|}
DECL|method|assertSubtypeBeforeSupertype (Iterable<? extends TypeToken<?>> types)
specifier|private
specifier|static
name|void
name|assertSubtypeBeforeSupertype
