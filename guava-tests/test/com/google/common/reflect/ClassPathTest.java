...
expr_stmt|;
block|}
DECL|method|testResourceScanner ()
specifier|public
name|void
name|testResourceScanner
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|(
literal|"No jar file found!"
argument_list|)
throw|;
block|}
catch|catch
parameter_list|(
name|StopScanningException
name|expected
parameter_list|)
block|{
return|return
...
annotation|@
name|Override
DECL|method|scanFrom (File file, ClassLoader loader)
specifier|protected
name|void
name|scanFrom
parameter_list|(
...
throw|;
block|}
comment|// Special exception just to terminate the scanning when we get any jar file to use.
DECL|class|StopScanningException
specifier|private
specifier|static
specifier|final
class|class
