...
name|RangeTest
operator|.
name|SerializableTesterWrapper
operator|.
name|TheRealThing
operator|.
name|reserializeAndAssertUnlessGwt
import|;
end_import
...
expr_stmt|;
block|}
comment|/*    * Give two fields the same name, and mark one @GwtIncompatible. The @GwtIncompatible takes    * precedence under plain Java. It actually does something, and the GWT one does not.    *    * Yeah, this is evil, and we should probably just emulate ST to be a no-op under    * GWT. TODO(cpovirk): do that    */
DECL|class|SerializableTesterWrapper
specifier|abstract
specifier|static
class|class
name|SerializableTesterWrapper
block|{
DECL|method|test (Object object)
specifier|abstract
name|void
name|test
parameter_list|(
...
block|}
decl_stmt|;
DECL|method|reserializeAndAssertUnlessGwt (Object object)
specifier|static
name|void
name|reserializeAndAssertUnlessGwt
parameter_list|(
