...
begin_comment
comment|/**  * Collection tests for {@link Table} implementations.  *  * @author Jared Levy  */
end_comment
...
name|named
argument_list|(
literal|"TreeBasedTable.rowKeySet.headSet"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"TreeBasedTable.rowKeySet.tailSet"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"TreeBasedTable.rowKeySet.subSet"
argument_list|)
operator|.
name|withFeatures
argument_list|(
