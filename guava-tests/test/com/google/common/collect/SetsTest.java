...
name|named
argument_list|(
literal|"Sets.unmodifiableNavigableSet[TreeSet], reserialized"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testFilterSorted ()
specifier|public
name|void
name|testFilterSorted
parameter_list|()
block|{
name|SortedSet
argument_list|<
...
name|assertEquals
argument_list|(
literal|"FirstOnModifiedSortedSet"
argument_list|,
literal|0L
argument_list|,
name|filteredEven
...
name|assertEquals
argument_list|(
literal|"LastOnModifiedSortedSet"
argument_list|,
literal|12L
argument_list|,
name|filteredEven
...
argument_list|)
DECL|method|testFilterNavigable ()
specifier|public
name|void
name|testFilterNavigable
parameter_list|()
block|{
name|NavigableSet
argument_list|<
...
name|assertEquals
argument_list|(
literal|"FirstOnModifiedNavigableSet"
argument_list|,
literal|0L
argument_list|,
name|filteredEven
...
name|assertEquals
argument_list|(
literal|"LastOnModifiedNavigableSet"
argument_list|,
literal|12L
argument_list|,
name|filteredEven
...
argument_list|)
decl_stmt|;
DECL|method|testFilteredSortedEmpty_size ()
specifier|public
name|void
name|testFilteredSortedEmpty_size
parameter_list|()
block|{
name|assertEquals
argument_list|(
literal|"filterEmptySize"
argument_list|,
literal|0
argument_list|,
name|filteredEmpty
...
expr_stmt|;
block|}
DECL|method|testFilteredSortedEmpty_first ()
specifier|public
name|void
name|testFilteredSortedEmpty_first
parameter_list|()
block|{
try|try
block|{
...
name|fail
argument_list|(
literal|"CallFirstOnEmptySetThrowsException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|{}
block|}
DECL|method|testFilteredSortedEmpty_last ()
specifier|public
name|void
name|testFilteredSortedEmpty_last
parameter_list|()
block|{
try|try
block|{
...
name|fail
argument_list|(
literal|"CallLastOnEmptySetThrowsException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
DECL|field|filterAllElements
specifier|static
name|SortedSet
argument_list|<
name|Long
argument_list|>
name|filterAllElements
init|=
name|Sets
operator|.
name|filter
...
argument_list|)
decl_stmt|;
DECL|method|testFilteredSortedAllFiltered_size ()
specifier|public
name|void
name|testFilteredSortedAllFiltered_size
parameter_list|()
block|{
name|assertEquals
argument_list|(
literal|"filterAllElementsSize"
argument_list|,
literal|0
argument_list|,
name|filterAllElements
...
expr_stmt|;
block|}
DECL|method|testFilteredSortedAllFiltered_first ()
specifier|public
name|void
name|testFilteredSortedAllFiltered_first
parameter_list|()
block|{
try|try
block|{
...
name|fail
argument_list|(
literal|"CallFirstOnSetWithAllElementsFilteredThrowsException"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|{}
block|}
DECL|method|testFilteredSortedAllFiltered_last ()
specifier|public
name|void
name|testFilteredSortedAllFiltered_last
parameter_list|()
block|{
try|try
block|{
...
name|fail
argument_list|(
literal|"CallLastOnSetWithAllElementsFilteredThrowsException"
argument_list|)
expr_stmt|;
block|}
catch|catch
