...
block|{     }
block|}
DECL|method|testCustomOffsetExceptions ()
specifier|public
name|void
name|testCustomOffsetExceptions
parameter_list|()
block|{
try|try
block|{
operator|new
name|MyIntegerDomain
argument_list|()
operator|.
name|offset
argument_list|(
...
return|;
block|}
comment|// Do *not* override offset() to delegate: We want to test the default implementation.
annotation|@
name|Override
