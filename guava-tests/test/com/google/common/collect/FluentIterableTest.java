...
specifier|public
name|void
name|testConcatIntersectionType
parameter_list|()
block|{
name|Iterable
argument_list|<
...
argument_list|)
decl_stmt|;
comment|/* The following fails to compile:      *      * The method append(Iterable<? extends FluentIterableTest.A>) in the type      * FluentIterable<FluentIterableTest.A> is not applicable for the arguments      * (Iterable<FluentIterableTest.B>)      */
comment|// FluentIterable.from(aIterable).append(bIterable);
comment|/* The following fails to compile:      *      * The method filter(Predicate<? super Object>) in the type FluentIterable<Object> is not      * applicable for the arguments (Predicate<FluentIterableTest.X>)      */
comment|// FluentIterable.of().append(aIterable).append(bIterable).filter(xPredicate);
block|}
...
expr_stmt|;
block|}
comment|// TODO(kevinb): add assertThat(Stream) to Truth?
DECL|class|Help
specifier|static
class|class
name|Help
