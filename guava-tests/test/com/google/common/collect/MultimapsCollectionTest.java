...
argument_list|>
block|{
DECL|method|filter (SetMultimap<String, Integer> multimap)
specifier|abstract
name|SetMultimap
argument_list|<
name|String
...
annotation|@
name|Override
DECL|method|createCollection (Iterable<? extends Integer> values)
specifier|public
name|Collection
argument_list|<
name|Integer
...
return|;
block|}
DECL|method|filter (ListMultimap<String, Integer> multimap)
specifier|abstract
name|ListMultimap
argument_list|<
name|String
...
name|MultimapAsMapTester
operator|.
name|getAsMapEntrySetIteratorRemoveMethod
argument_list|()
argument_list|,
name|MultimapEntriesTester
operator|.
name|getIteratorRemoveMethod
argument_list|()
argument_list|)
decl_stmt|;
name|TestSuite
...
name|named
argument_list|(
literal|"Multimaps.filterKeys[SetMultimap, Predicate]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"Multimaps.filterKeys[ListMultimap, Predicate]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"Multimaps.filterKeys[Multimaps.filterKeys[ListMultimap], Predicate]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"Multimaps.filterValues[SetMultimap, Predicate]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"Multimaps.filterEntries[SetMultimap, Predicate]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
