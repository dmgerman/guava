...
name|assertTrue
argument_list|(
literal|"MinMaxHeap not intact after "
operator|+
name|heapSize
operator|+
literal|" insertions"
...
name|assertTrue
argument_list|(
literal|"Heap not intact after "
operator|+
name|numberOfModifications
operator|+
literal|" random mixture of operations"
argument_list|,
name|mmHeap
operator|.
name|isIntact
...
argument_list|)
expr_stmt|;
comment|// Last two from forgetMeNot.
name|assertEquals
argument_list|(
operator|(
name|Integer
