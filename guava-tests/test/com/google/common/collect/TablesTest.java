...
name|TestCase
block|{
comment|// The bulk of the toTable tests can be found in TableCollectorsTest.
comment|// This gives minimal coverage to the forwarding functions
DECL|method|testToTableSanityTest ()
specifier|public
name|void
name|testToTableSanityTest
parameter_list|()
block|{
name|Collector
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testToTableMergingSanityTest ()
specifier|public
name|void
name|testToTableMergingSanityTest
parameter_list|()
block|{
name|Collector
argument_list|<
