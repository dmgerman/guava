...
return|;
block|}
comment|// The bulk of the toImmutableTable tests can be found in TableCollectorsTest.
comment|// This gives minimal coverage to the forwarding functions
DECL|method|testToImmutableTableSanityTest ()
specifier|public
name|void
name|testToImmutableTableSanityTest
parameter_list|()
block|{
name|Collector
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testToImmutableTableMergingSanityTest ()
specifier|public
name|void
name|testToImmutableTableMergingSanityTest
parameter_list|()
block|{
name|Collector
argument_list|<
...
expr_stmt|;
block|}
DECL|method|validateReserialization (Table<R, C, V> original)
specifier|private
specifier|static
parameter_list|<
name|R
