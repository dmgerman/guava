...
specifier|public
name|void
name|testToImmutableSortedMultiset
parameter_list|()
block|{
name|BiPredicate
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testToImmutableSortedMultisetCountFunction ()
specifier|public
name|void
name|testToImmutableSortedMultisetCountFunction
parameter_list|()
block|{
name|BiPredicate
argument_list|<
...
parameter_list|()
block|{
comment|// Depending on JDK version, either toArray() or toArray(T[]) may be called... use this class
comment|// rather than mocking to ensure that one of those methods is called.
class|class
name|TestArrayList
parameter_list|<
name|E
