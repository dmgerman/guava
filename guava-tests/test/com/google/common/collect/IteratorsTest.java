...
return|;
block|}
DECL|method|testRecursiveCallsToPeekingIteratorShouldAvoidRewrapping ()
specifier|public
name|void
name|testRecursiveCallsToPeekingIteratorShouldAvoidRewrapping
parameter_list|()
block|{
name|Iterator
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// Should be able to make a PeekingIterator<T> from an Iterator<? extends T>
...
name|assertSame
argument_list|(
literal|"Should not rewrap iterator returned by peekingIterator()"
argument_list|,
name|first
argument_list|,
name|second
