...
begin_comment
comment|/**  * Tests for {@link IncidenceSetDirectedGraph} with default graph configuration.  *  * @see GraphConfig  */
end_comment
...
name|class
argument_list|)
DECL|class|IncidenceSetDirectedGraphTest
specifier|public
class|class
name|IncidenceSetDirectedGraphTest
extends|extends
name|IncidenceSetSimpleDirectedGraphTest
block|{
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|// TODO(kak): Can't we ditch this and just use PackageSanityTests?
annotation|@
name|Test
