...
begin_comment
comment|/**  * Tests for {@link IncidenceSetDirectedGraph}, creating a simple directed graph (parallel and  * self-loop edges are not allowed).  */
end_comment
...
name|class
argument_list|)
DECL|class|IncidenceSetSimpleDirectedGraphTest
specifier|public
class|class
