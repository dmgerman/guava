...
begin_comment
comment|/**  * Tests for {@link IncidenceSetUndirectedGraph} with default graph configuration.  *  * @see GraphConfig  */
end_comment
...
name|class
argument_list|)
DECL|class|IncidenceSetUndirectedGraphTest
specifier|public
class|class
...
name|format
argument_list|(
literal|"config: %s, nodes: %s, edges: {%s=[%s]}"
argument_list|,
name|graph
operator|.
name|config
