...
begin_comment
comment|/**  * Unit tests for {@link Hashing}.  *  *<p>TODO(b/33919189): Migrate repeated testing methods to {@link #HashTestUtils} and tweak unit  * tests to reference them from there.  *  * @author Dimitris Andreou  * @author Kurt Alfred Kluever  */
end_comment
...
name|assertEquals
argument_list|(
literal|"Hashing.sipHash24(506097522914230528, 1084818905618843912)"
argument_list|,
name|Hashing
operator|.
name|sipHash24
...
expr_stmt|;
block|}
comment|// This isn't specified by contract, but it'll still be nice to know if this behavior changes.
DECL|method|testConcatenating_equals ()
specifier|public
name|void
name|testConcatenating_equals
parameter_list|()
block|{
operator|new
name|EqualsTester
...
expr_stmt|;
block|}
DECL|method|testConcatenatingIterable_bits ()
specifier|public
name|void
name|testConcatenatingIterable_bits
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testConcatenatingVarArgs_bits ()
specifier|public
name|void
name|testConcatenatingVarArgs_bits
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testConcatenatingHashFunction_makeHash ()
specifier|public
name|void
name|testConcatenatingHashFunction_makeHash
parameter_list|()
block|{
name|byte
index|[]
...
expr_stmt|;
block|}
DECL|method|testHashIntReverseBytesVsHashBytesIntsToByteArray ()
specifier|public
name|void
name|testHashIntReverseBytesVsHashBytesIntsToByteArray
parameter_list|()
block|{
name|int
name|input
...
expr_stmt|;
block|}
DECL|method|testHashIntVsForLoop ()
specifier|public
name|void
name|testHashIntVsForLoop
parameter_list|()
block|{
name|int
name|input
...
name|EMPTY_STRING
argument_list|,
literal|"38b060a751ac96384cd9327eb1b1e36a21fdb71114be07434c0cc7bf63f6e1da2"
operator|+
literal|"74edebfe76f65fbd51ad2f14898b95b"
argument_list|)
decl|.
name|put
argument_list|(
...
name|TQBFJOTLD
argument_list|,
literal|"ca737f1014a48f4c0b6dd43cb177b0afd9e5169367544c494011e3317dbf9a509"
operator|+
literal|"cb1e5dc1e85a941bbee3d7f2afbc9b1"
argument_list|)
decl|.
name|put
argument_list|(
...
name|TQBFJOTLDP
argument_list|,
literal|"ed892481d8272ca6df370bf706e4d7bc1b5739fa2177aae6c50e946678718fc67"
operator|+
literal|"a7af2819a021c2fc34e91bdb63409d7"
argument_list|)
decl|.
name|put
argument_list|(
...
name|Exception
block|{
comment|// The following legacy hashing function methods have been covered by unit testing already.
name|List
argument_list|<
name|String
argument_list|>
name|legacyHashingMethodNames
init|=
name|ImmutableList
operator|.
name|of
...
argument_list|()
argument_list|)
comment|// only the public methods
operator|&&
name|method
operator|.
...
expr_stmt|;
block|}
DECL|method|testSeedlessHashFunctionEquals ()
specifier|public
name|void
name|testSeedlessHashFunctionEquals
parameter_list|()
throws|throws
name|Exception
block|{
name|assertSeedlessHashFunctionEquals
argument_list|(
name|Hashing
operator|.
name|class
...
expr_stmt|;
block|}
DECL|method|testSeededHashFunctionEquals ()
specifier|public
name|void
name|testSeededHashFunctionEquals
parameter_list|()
throws|throws
name|Exception
block|{
name|assertSeededHashFunctionEquals
argument_list|(
name|Hashing
operator|.
name|class
...
expr_stmt|;
block|}
DECL|method|assertSeedlessHashFunctionEquals (Class<?> clazz)
specifier|static
name|void
name|assertSeedlessHashFunctionEquals
parameter_list|(
...
condition|)
block|{
comment|// only the seed-less hash functions
name|HashFunction
name|hashFunction1a
init|=
operator|(
...
argument_list|()
expr_stmt|;
comment|// Make sure we're returning not only equal instances, but constants.
name|assertSame
argument_list|(
name|hashFunction1a
argument_list|,
...
block|}
block|}
DECL|method|assertSeededHashFunctionEquals (Class<?> clazz)
specifier|static
name|void
name|assertSeededHashFunctionEquals
parameter_list|(
...
operator|!=
literal|0
comment|// only the seeded hash functions
operator|&&
operator|!
name|method
operator|.
...
name|equals
argument_list|(
literal|"concatenating"
argument_list|)
comment|// don't test Hashing.concatenating()
operator|&&
operator|!
name|method
operator|.
...
name|fail
argument_list|(
literal|"Unable to create a random parameter for "
operator|+
name|method
operator|.
name|getParameterTypes
...
block|}
block|}
comment|// Parity tests taken from //util/hash/hash_unittest.cc
block|}
end_class
