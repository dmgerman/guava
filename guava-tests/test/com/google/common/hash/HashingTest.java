...
begin_comment
comment|/**  * Unit tests for functions of {@code Hashing} that don't have their own tests.  */
end_comment
...
expr_stmt|;
block|}
DECL|method|testCombineOrdered_null ()
specifier|public
name|void
name|testCombineOrdered_null
parameter_list|()
block|{
try|try
block|{
...
expr_stmt|;
block|}
DECL|method|testCombineUnordered_null ()
specifier|public
name|void
name|testCombineUnordered_null
parameter_list|()
block|{
try|try
block|{
