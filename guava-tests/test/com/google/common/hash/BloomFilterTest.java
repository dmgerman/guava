...
expr_stmt|;
block|}
DECL|method|testGetDefaultStrategyFromSystemProperty ()
specifier|public
name|void
name|testGetDefaultStrategyFromSystemProperty
parameter_list|()
block|{
comment|// clear the property to test the case when the property is not set (the default)
name|System
operator|.
name|clearProperty
argument_list|(
