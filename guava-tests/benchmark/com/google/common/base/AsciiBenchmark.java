...
argument_list|)
expr_stmt|;
comment|// fix the seed so results are comparable across runs
name|int
name|nonAlpha
init|=
name|size
...
parameter_list|)
block|{
comment|// This benchmark has no concept of "noWorkToDo".
name|String
name|upperString
init|=
name|testString
...
return|;
block|}
DECL|method|charSequenceToUpperCase (CharSequence chars)
specifier|static
name|String
name|charSequenceToUpperCase
parameter_list|(
