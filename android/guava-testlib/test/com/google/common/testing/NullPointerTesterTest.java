...
block|}
DECL|method|staticOneArgJsr305NullableCorrectlyDoesNotThrowNPE (@heckForNull String s)
specifier|public
specifier|static
name|void
...
comment|// null?  no problem
block|}
DECL|method|staticOneArgNullableCorrectlyDoesNotThrowNPE (@heckForNull String s)
specifier|public
specifier|static
name|void
...
block|}
DECL|method|staticOneArgNullableCorrectlyThrowsOtherThanNPE (@heckForNull String s)
specifier|public
specifier|static
name|void
...
block|}
DECL|method|staticOneArgNullableThrowsNPE (@heckForNull String s)
specifier|public
specifier|static
name|void
...
comment|// null?  no problem
block|}
DECL|method|oneArgNullableCorrectlyDoesNotThrowNPE (@heckForNull String s)
specifier|public
name|void
...
comment|// ok, as long as it's not NullPointerException
block|}
DECL|method|oneArgNullableCorrectlyThrowsOtherThanNPE (@heckForNull String s)
specifier|public
name|void
...
comment|// doesn't check if you said you'd accept null, but you don't
block|}
DECL|method|oneArgNullableThrowsNPE (@heckForNull String s)
specifier|public
name|void
...
block|,   }
decl_stmt|;
DECL|class|ThrowsIae
specifier|private
specifier|static
class|class
name|ThrowsIae
block|{
DECL|method|christenPoodle (String name)
specifier|public
specifier|static
name|void
name|christenPoodle
...
block|}
block|}
DECL|class|ThrowsSomethingElse
specifier|private
specifier|static
class|class
name|ThrowsSomethingElse
block|{
DECL|method|christenPoodle (String name)
specifier|public
specifier|static
...
block|}
block|}
DECL|method|testDontAcceptIae ()
specifier|public
name|void
name|testDontAcceptIae
parameter_list|()
block|{
name|NullPointerTester
name|tester
...
block|}
block|}
DECL|method|testMessageOtherException ()
specifier|public
name|void
name|testMessageOtherException
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Should report error when different exception is thrown"
argument_list|,
name|foundProblem
argument_list|)
expr_stmt|;
block|}
DECL|method|testMessageNoException ()
specifier|public
name|void
name|testMessageNoException
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertTrue
argument_list|(
literal|"Should report error when no exception is thrown"
argument_list|,
name|foundProblem
argument_list|)
expr_stmt|;
...
argument_list|)
comment|// false positive; b/122617528
DECL|method|normalNullable (String first, @CheckForNull Integer second)
specifier|public
name|void
name|normalNullable
parameter_list|(
...
argument_list|)
comment|// false positive; b/122617528
DECL|method|nullableNormal (@heckForNull String first, Integer second)
specifier|public
name|void
name|nullableNormal
parameter_list|(
...
argument_list|)
comment|// false positive; b/122617528
DECL|method|nullableNullable (@heckForNull String first, @CheckForNull Integer second)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|oneNullableArg (@heckForNull String s)
specifier|public
name|void
name|oneNullableArg
parameter_list|(
...
parameter_list|)
block|{}
DECL|method|oneNullableArgThrows (@heckForNull String s)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|twoMixedArgs (String s, @CheckForNull Integer i)
specifier|public
name|void
name|twoMixedArgs
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|twoMixedArgs (@heckForNull Integer i, String s)
specifier|public
name|void
name|twoMixedArgs
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|twoMixedArgsThrows (String s, @CheckForNull Integer i)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|twoMixedArgsThrows (@heckForNull Integer i, String s)
specifier|public
name|void
name|twoMixedArgsThrows
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|twoNullableArgs (@heckForNull String s, @CheckForNull Integer i)
specifier|public
name|void
...
parameter_list|)
block|{}
DECL|method|twoNullableArgsThrowsFirstArg (@heckForNull String s, @CheckForNull Integer i)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|twoNullableArgsThrowsSecondArg (@heckForNull String s, @CheckForNull Integer i)
specifier|public
name|void
...
expr_stmt|;
block|}
DECL|method|staticOneNullableArg (@heckForNull String s)
specifier|public
specifier|static
name|void
...
parameter_list|)
block|{}
DECL|method|staticOneNullableArgThrows (@heckForNull String s)
specifier|public
specifier|static
name|void
...
annotation|@
name|Override
DECL|method|oneArg (@heckForNull String s)
specifier|public
name|void
name|oneArg
parameter_list|(
...
name|BaseClassThatFailsToThrow
block|{
DECL|method|oneArg (@heckForNull CharSequence s)
specifier|public
name|void
name|oneArg
parameter_list|(
...
name|ClassThatFailsToThrowForStatic
block|{
DECL|method|staticOneArg (@heckForNull String s)
specifier|static
name|void
name|staticOneArg
parameter_list|(
...
block|{
DECL|method|foo (@heckForNull HardToCreate ignored, String required)
specifier|public
name|void
name|foo
parameter_list|(
...
block|{
DECL|method|PrivateClassWithPrivateConstructor (@heckForNull Integer argument)
specifier|private
name|PrivateClassWithPrivateConstructor
parameter_list|(
annotation|@
...
begin_class
DECL|class|ConverterDefaultValueChecker
specifier|private
specifier|static
class|class
name|ConverterDefaultValueChecker
extends|extends
name|DefaultValueChecker
block|{
annotation|@
...
argument_list|)
comment|// called by NullPointerTester
DECL|method|checkArray (Converter<String, Integer> c, String s)
specifier|public
name|void
name|checkArray
parameter_list|(
...
literal|"unchecked"
argument_list|)
comment|// We are checking it anyway
name|Converter
argument_list|<
name|String
argument_list|,
...
begin_function
DECL|method|testConverterDefaultValue ()
specifier|public
name|void
name|testConverterDefaultValue
parameter_list|()
block|{
operator|new
name|ConverterDefaultValueChecker
...
begin_function
DECL|method|testNonStaticInnerClass ()
specifier|public
name|void
name|testNonStaticInnerClass
parameter_list|()
block|{
try|try
block|{
...
begin_class
DECL|class|DoesNotOverrideEquals
specifier|static
class|class
name|DoesNotOverrideEquals
block|{
...
begin_function
DECL|method|testEqualsMethod ()
specifier|public
name|void
name|testEqualsMethod
parameter_list|()
block|{
name|shouldPass
argument_list|(
...
begin_class
DECL|class|FailOnOneOfTwoConstructors
specifier|private
specifier|static
specifier|final
class|class
name|FailOnOneOfTwoConstructors
block|{
annotation|@
name|SuppressWarnings
argument_list|(
...
argument_list|)
comment|// Called by reflection
DECL|method|FailOnOneOfTwoConstructors (String s)
specifier|public
name|FailOnOneOfTwoConstructors
parameter_list|(
name|String
...
argument_list|)
comment|// Called by reflection
DECL|method|FailOnOneOfTwoConstructors (Object o)
specifier|public
name|FailOnOneOfTwoConstructors
parameter_list|(
name|Object
...
begin_function
DECL|method|testConstructor_Ignored_ShouldPass ()
specifier|public
name|void
name|testConstructor_Ignored_ShouldPass
parameter_list|()
throws|throws
name|Exception
block|{
...
begin_function
DECL|method|testConstructor_ShouldFail ()
specifier|public
name|void
name|testConstructor_ShouldFail
parameter_list|()
throws|throws
name|Exception
block|{
