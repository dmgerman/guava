...
begin_comment
comment|/**  * Tests representing the contract of {@link Map}. Concrete subclasses of this base class test  * conformance of concrete {@link Map} subclasses to that contract.  *  * @param<K> the type of keys used by the maps under test  * @param<V> the type of mapped values used the maps under test  * @author George van den Driessche  */
end_comment

begin_comment
comment|// TODO: Descriptive assertion messages, with hints as to probable fixes.
end_comment

begin_comment
comment|// TODO: Add another constructor parameter indicating whether the class under test is ordered, and
end_comment

begin_comment
comment|// check the order if so.
end_comment

begin_comment
comment|// TODO: Refactor to share code with SetTestBuilder etc.
end_comment
...
argument_list|)
expr_stmt|;
name|assertEntrySetNotContainsString
argument_list|(
name|entrySet
argument_list|)
expr_stmt|;
...
argument_list|)
DECL|method|assertEntrySetNotContainsString (Set<Entry<K, V>> entrySet)
specifier|private
name|void
name|assertEntrySetNotContainsString
parameter_list|(
...
parameter_list|)
block|{
comment|// Very unlikely that a buggy collection would ever return true. It might accidentally throw.
name|assertFalse
argument_list|(
name|entrySet
operator|.
