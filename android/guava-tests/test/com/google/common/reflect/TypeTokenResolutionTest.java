...
begin_function
DECL|method|testTwoStageResolution ()
specifier|public
name|void
name|testTwoStageResolution
parameter_list|()
block|{
class|class
name|ForTwoStageResolution
parameter_list|<
name|A
extends|extends
name|Number
...
argument_list|)
block|{}
comment|// B's bound may have already resolved to something.
comment|// Make sure it can still further resolve when given a context.
operator|.
name|where
argument_list|(
operator|new
