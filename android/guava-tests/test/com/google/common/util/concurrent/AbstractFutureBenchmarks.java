...
begin_class
DECL|class|AbstractFutureBenchmarks
specifier|final
class|class
name|AbstractFutureBenchmarks
block|{
DECL|method|AbstractFutureBenchmarks ()
specifier|private
name|AbstractFutureBenchmarks
parameter_list|()
block|{}
DECL|interface|Facade
interface|interface
name|Facade
parameter_list|<
name|T
...
function_decl|;
block|}
DECL|class|NewAbstractFutureFacade
specifier|private
specifier|static
class|class
name|NewAbstractFutureFacade
parameter_list|<
name|T
parameter_list|>
extends|extends
...
block|}
block|}
DECL|class|OldAbstractFutureFacade
specifier|private
specifier|static
class|class
name|OldAbstractFutureFacade
parameter_list|<
name|T
parameter_list|>
extends|extends
...
function_decl|;
block|}
DECL|method|awaitWaiting (Thread t)
specifier|static
name|void
name|awaitWaiting
parameter_list|(
...
annotation|@
name|CanIgnoreReturnValue
DECL|method|set (@heckForNull V value)
specifier|protected
name|boolean
name|set
parameter_list|(
...
DECL|method|set (@heckForNull V v)
name|boolean
name|set
parameter_list|(
annotation|@
...
DECL|method|complete (@heckForNull V v, @CheckForNull Throwable t, int finalState)
specifier|private
name|boolean
name|complete
parameter_list|(
...
block|}
block|}
DECL|method|cancellationExceptionWithCause ( @heckForNull String message, @CheckForNull Throwable cause)
specifier|static
specifier|final
name|CancellationException
name|cancellationExceptionWithCause
