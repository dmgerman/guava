...
argument_list|(
literal|"getExclusiveOwnerThread"
argument_list|)
decl_stmt|;
name|getExclusiveOwnerThread
operator|.
...
DECL|method|awaitBlockedOnInstanceOf (Thread t, Class<?> blocker)
specifier|private
specifier|static
name|void
name|awaitBlockedOnInstanceOf
...
condition|(
operator|!
name|isThreadBlockedOnInstanceOf
argument_list|(
name|t
argument_list|,
name|blocker
...
block|}
block|}
DECL|method|isThreadBlockedOnInstanceOf (Thread t, Class<?> blocker)
specifier|private
specifier|static
name|boolean
name|isThreadBlockedOnInstanceOf
