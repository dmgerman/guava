...
annotation|@
name|GwtIncompatible
DECL|method|testWhenAllSucceed_releasesMemory ()
specifier|public
name|void
name|testWhenAllSucceed_releasesMemory
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|null
expr_stmt|;
comment|// Futures should be collected even if combiner future never finishes.
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
