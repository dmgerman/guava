...
expr_stmt|;
block|}
DECL|method|testImmediateVoidFuture ()
specifier|public
name|void
name|testImmediateVoidFuture
parameter_list|()
throws|throws
name|Exception
block|{
...
name|contains
argument_list|(
literal|"[status=SUCCESS, result=[null]]"
argument_list|)
expr_stmt|;
block|}
...
name|GwtIncompatible
comment|// Threads
DECL|method|testTransformAsync_functionToString ()
specifier|public
name|void
name|testTransformAsync_functionToString
parameter_list|()
throws|throws
name|Exception
block|{
...
DECL|method|testCatchingAsync_inputCancelledWithoutFallback ()
specifier|public
name|void
name|testCatchingAsync_inputCancelledWithoutFallback
parameter_list|()
throws|throws
name|Exception
block|{
...
name|GwtIncompatible
comment|// Threads
DECL|method|testCatchingAsync_functionToString ()
specifier|public
name|void
name|testCatchingAsync_functionToString
parameter_list|()
throws|throws
name|Exception
block|{
...
name|GwtIncompatible
comment|// non-Throwable exceptionType
DECL|method|testCatching_inputCancelledWithoutFallback ()
specifier|public
name|void
name|testCatching_inputCancelledWithoutFallback
parameter_list|()
throws|throws
name|Exception
block|{
...
name|GwtIncompatible
comment|// threads
DECL|method|testSubmitAsync_asyncCallable_cancelledWhileApplyingFunction ()
specifier|public
name|void
name|testSubmitAsync_asyncCallable_cancelledWhileApplyingFunction
parameter_list|()
throws|throws
name|InterruptedException
throws|,
...
name|GwtIncompatible
comment|// threads
DECL|method|testSubmitAsync_asyncCallable_cancelledBeforeApplyingFunction ()
specifier|public
name|void
name|testSubmitAsync_asyncCallable_cancelledBeforeApplyingFunction
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
name|GwtIncompatible
comment|// threads
DECL|method|testSubmitAsync_asyncCallable_returnsInterruptedFuture ()
specifier|public
name|void
name|testSubmitAsync_asyncCallable_returnsInterruptedFuture
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
expr_stmt|;
block|}
DECL|method|testSubmit_callable_returnsValue ()
specifier|public
name|void
name|testSubmit_callable_returnsValue
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSubmit_callable_throwsException ()
specifier|public
name|void
name|testSubmit_callable_throwsException
parameter_list|()
block|{
specifier|final
name|Exception
...
block|}
block|}
DECL|method|testSubmit_runnable_completesAfterRun ()
specifier|public
name|void
name|testSubmit_runnable_completesAfterRun
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSubmit_runnable_throwsException ()
specifier|public
name|void
name|testSubmit_runnable_throwsException
parameter_list|()
throws|throws
name|Exception
block|{
...
name|GwtIncompatible
comment|// threads
DECL|method|testScheduleAsync_asyncCallable_error ()
specifier|public
name|void
name|testScheduleAsync_asyncCallable_error
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
name|GwtIncompatible
comment|// threads
DECL|method|testScheduleAsync_asyncCallable_nullInsteadOfFuture ()
specifier|public
name|void
name|testScheduleAsync_asyncCallable_nullInsteadOfFuture
parameter_list|()
throws|throws
name|Exception
block|{
...
name|GwtIncompatible
comment|// threads
DECL|method|testScheduleAsync_asyncCallable_cancelledWhileApplyingFunction ()
specifier|public
name|void
name|testScheduleAsync_asyncCallable_cancelledWhileApplyingFunction
parameter_list|()
throws|throws
name|InterruptedException
throws|,
...
name|GwtIncompatible
comment|// threads
DECL|method|testScheduleAsync_asyncCallable_cancelledBeforeCallingFunction ()
specifier|public
name|void
name|testScheduleAsync_asyncCallable_cancelledBeforeCallingFunction
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
expr_stmt|;
block|}
DECL|method|constantAsyncCallable (final ListenableFuture<T> returnValue)
specifier|private
specifier|static
parameter_list|<
name|T
...
name|GwtIncompatible
comment|// threads
DECL|method|testWhenAllComplete_noLeakInterruption ()
specifier|public
name|void
name|testWhenAllComplete_noLeakInterruption
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
decl_stmt|;
comment|// We'd like for all the following to compile.
name|ListenableFuture
argument_list|<
name|String
argument_list|>
...
comment|// unused = whenAllComplete(futures).call(combiner);
comment|// Workaround for the above:
name|unused
operator|=
name|whenAllComplete
argument_list|(
...
name|Exception
block|{
comment|// Make this executor terminate after this task so that the test can tell when
comment|// futureResult has received resultOfCombiner.
name|executor
operator|.
name|shutdown
argument_list|()
...
argument_list|)
decl_stmt|;
comment|// Waiting on backing futures
name|assertThat
argument_list|(
name|futureResult
operator|.
...
argument_list|)
expr_stmt|;
comment|// Once the backing futures are done there's a (brief) moment where we know nothing
name|assertThat
argument_list|(
name|futureResult
operator|.
...
argument_list|()
expr_stmt|;
comment|// Need to wait for resultFuture to be returned.
name|assertTrue
argument_list|(
name|executor
operator|.
...
argument_list|)
expr_stmt|;
comment|// But once the async function has returned a future we can include that in the toString
name|assertThat
argument_list|(
name|futureResult
operator|.
...
name|GwtIncompatible
comment|// threads
DECL|method|testWhenAllCompleteRunnable_resultCanceledWithoutInterrupt_doesNotInterruptRunnable ()
specifier|public
name|void
name|testWhenAllCompleteRunnable_resultCanceledWithoutInterrupt_doesNotInterruptRunnable
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|final
name|CountDownLatch
name|combinerCompletedWithoutInterrupt
init|=
operator|new
name|CountDownLatch
argument_list|(
...
parameter_list|)
block|{
comment|// Ensure the thread's interrupt status is preserved.
name|Thread
operator|.
name|currentThread
argument_list|()
...
name|GwtIncompatible
comment|// threads
DECL|method|testWhenAllCompleteRunnable_resultCanceledWithInterrupt_InterruptsRunnable ()
specifier|public
name|void
name|testWhenAllCompleteRunnable_resultCanceledWithInterrupt_InterruptsRunnable
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|GwtIncompatible
DECL|method|testWhenAllSucceed_releasesInputFuturesUponSubmission ()
specifier|public
name|void
name|testWhenAllSucceed_releasesInputFuturesUponSubmission
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|null
expr_stmt|;
comment|/*      * Futures should be collected even if combiner never runs. This is kind of a silly test, since      * the combiner is almost certain to hold its own reference to the futures, and a real app would      * hold a reference to the executor and thus to the combiner. What we really care about is that      * the futures are released once the combiner is done running. But we happen to provide this      * earlier cleanup at the moment, so we're testing it.      */
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
...
annotation|@
name|GwtIncompatible
DECL|method|testWhenAllComplete_releasesInputFuturesUponCancellation ()
specifier|public
name|void
name|testWhenAllComplete_releasesInputFuturesUponCancellation
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|null
expr_stmt|;
comment|// Future should be collected because whenAll*Complete* doesn't need to look at its result.
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
...
annotation|@
name|GwtIncompatible
DECL|method|testWhenAllSucceed_releasesCallable ()
specifier|public
name|void
name|testWhenAllSucceed_releasesCallable
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|null
expr_stmt|;
comment|// combiner should be collected even if the future it returns never completes.
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
...
name|isEqualTo
argument_list|(
literal|"You can't fire me, I quit."
argument_list|)
expr_stmt|;
block|}
DECL|class|CancelPanickingFuture
specifier|private
specifier|static
specifier|final
class|class
...
argument_list|)
expr_stmt|;
comment|// All futures are now complete; outstanding inputs are cancelled
name|assertTrue
argument_list|(
name|future3
operator|.
...
specifier|public
name|void
name|testInputGCedIfUnreferenced
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|null
expr_stmt|;
comment|// First future is complete, should be unreferenced
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
...
literal|null
expr_stmt|;
comment|// No references to list or other output future, second future should be unreferenced
name|GcFinalization
operator|.
name|awaitClear
argument_list|(
...
return|;
block|}
DECL|method|tagged ( final String toString, final AsyncFunction<I, O> function)
specifier|private
specifier|static
parameter_list|<
name|I
...
return|;
block|}
DECL|method|tagged ( final String toString, final AsyncCallable<V> callable)
specifier|private
specifier|static
parameter_list|<
name|V
