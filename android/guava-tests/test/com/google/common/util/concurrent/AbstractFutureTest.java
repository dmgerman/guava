...
expr_stmt|;
block|}
DECL|method|testToString_oom ()
specifier|public
name|void
name|testToString_oom
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// A more organic OOM from a toString implementation
name|Object
name|object
init|=
operator|new
...
name|matches
argument_list|(
literal|"[^\\[]+\\[status=SUCCESS, result=\\[java.lang.Boolean@\\w+\\]\\]"
argument_list|)
expr_stmt|;
block|}
...
name|matches
argument_list|(
literal|"[^\\[]+\\[status=SUCCESS, result=\\[java.lang.String@\\w+\\]\\]"
argument_list|)
expr_stmt|;
block|}
