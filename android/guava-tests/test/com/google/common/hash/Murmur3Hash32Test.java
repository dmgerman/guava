...
literal|"deprecation"
argument_list|)
DECL|method|testKnownEncodedStringInputs ()
specifier|public
name|void
name|testKnownEncodedStringInputs
parameter_list|()
block|{
name|assertStringHash
argument_list|(
literal|0
argument_list|,
literal|""
...
literal|"deprecation"
argument_list|)
DECL|method|assertStringHash (int expected, String string, Charset charset)
specifier|private
name|void
name|assertStringHash
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|allBmp (String string)
specifier|private
name|boolean
name|allBmp
parameter_list|(
...
parameter_list|)
block|{
comment|// Ordinarily we'd use something like i += Character.charCount(string.codePointAt(i)) here. But
comment|// we can get away with i++ because the whole point of this method is to return false if we find
comment|// a code point that doesn't fit in a char.
for|for
control|(
name|int
name|i
...
literal|"deprecation"
argument_list|)
DECL|method|testEncodedStringInputs ()
specifier|public
name|void
name|testEncodedStringInputs
parameter_list|()
block|{
name|Random
name|rng
