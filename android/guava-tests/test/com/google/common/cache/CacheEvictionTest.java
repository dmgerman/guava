...
expr_stmt|;
block|}
comment|/**    * With an unlimited-size cache with maxWeight of 0, entries weighing 0 should still be cached.    * Entries with positive weight should not be cached (nor dump existing cache).    */
DECL|method|testEviction_maxWeight_zero ()
specifier|public
name|void
name|testEviction_maxWeight_zero
parameter_list|()
block|{
name|CountingRemovalListener
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// Even numbers are free, odd are too expensive
name|Weigher
argument_list|<
name|Integer
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// 5 won't be cached, won't dump cache
name|assertThat
argument_list|(
name|cache
operator|.
...
argument_list|)
expr_stmt|;
comment|// Should we pepper more of these calls throughout the above? Where?
name|CacheTesting
operator|.
name|checkValidState
argument_list|(
...
specifier|public
name|void
name|testEviction_maxWeight_entryTooBig
parameter_list|()
block|{
name|CountingRemovalListener
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// doesn't cache 5, doesn't evict
name|assertThat
argument_list|(
name|cache
operator|.
...
argument_list|)
expr_stmt|;
comment|// caches 1, evicts nothing
name|assertThat
argument_list|(
name|cache
operator|.
...
argument_list|)
expr_stmt|;
comment|// caches 4, evicts 1 and 3
name|assertThat
argument_list|(
name|cache
operator|.
...
expr_stmt|;
block|}
DECL|method|testEviction_overflow ()
specifier|public
name|void
name|testEviction_overflow
parameter_list|()
block|{
name|CountingRemovalListener
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testEviction_invalidateAll ()
specifier|public
name|void
name|testEviction_invalidateAll
parameter_list|()
block|{
comment|// test that .invalidateAll() resets total weight state correctly
name|IdentityLoader
argument_list|<
name|Integer
argument_list|>
...
argument_list|()
expr_stmt|;
comment|// add 5, 6, 7, 8, 9, 10, 11, 12
name|getAll
argument_list|(
name|cache
argument_list|,
...
block|}
block|}
DECL|method|objectWithHash (final int hash)
specifier|private
name|Object
name|objectWithHash
parameter_list|(
