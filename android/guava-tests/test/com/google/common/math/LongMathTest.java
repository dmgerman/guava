...
block|{     }
block|}
DECL|field|roundToDoubleTestCandidates
specifier|private
specifier|static
specifier|final
name|long
index|[]
name|roundToDoubleTestCandidates
init|=
block|{
literal|0
block|,
...
literal|4
block|,
literal|0x7ffffffffffffe00L
block|,
comment|// halfway between 2^63 and next-lower double
literal|0x7ffffffffffffe01L
block|,
comment|// above + 1
literal|0x7ffffffffffffdffL
block|,
comment|// above - 1
name|Long
operator|.
...
annotation|@
name|GwtIncompatible
DECL|method|testRoundToDoubleAgainstBigInteger ()
specifier|public
name|void
name|testRoundToDoubleAgainstBigInteger
parameter_list|()
block|{
for|for
control|(
...
annotation|@
name|GwtIncompatible
DECL|method|testRoundToDoubleAgainstBigIntegerUnnecessary ()
specifier|public
name|void
name|testRoundToDoubleAgainstBigIntegerUnnecessary
parameter_list|()
block|{
for|for
control|(
...
name|fail
argument_list|(
literal|"Expected ArithmeticException on roundToDouble("
operator|+
name|candidate
operator|+
literal|", UNNECESSARY)"
