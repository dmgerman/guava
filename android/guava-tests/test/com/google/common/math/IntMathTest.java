...
argument_list|)
expr_stmt|;
comment|// Extra work required to make GWT happy.
name|long
name|value
init|=
name|IntMath
...
return|;
block|}
DECL|method|assertOperationEquals (int a, int b, String op, int expected, int actual)
specifier|private
name|void
name|assertOperationEquals
parameter_list|(
...
DECL|method|testIsPrime ()
specifier|public
name|void
name|testIsPrime
parameter_list|()
block|{
comment|// Defer correctness tests to Long.isPrime
comment|// Check the first 100,000 integers
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|// Then check 1000 deterministic pseudo-random int values.
name|Random
name|rand
init|=
operator|new
