...
expr_stmt|;
block|}
DECL|method|testFromStringNonAsciiDigits ()
specifier|public
name|void
name|testFromStringNonAsciiDigits
parameter_list|()
block|{
comment|// Same as testFromStringUnusedDefaultPort but with Gujarati digits for port numbers.
name|checkFromStringCase
argument_list|(
literal|"gmail.com:à«®1"
argument_list|,
literal|77
argument_list|,
literal|null
