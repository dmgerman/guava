...
block|}
block|,
comment|// TODO(b/142723300): Add ElementOrder.stable() once it is supported
block|}
argument_list|)
return|;
block|}
...
decl_stmt|;
DECL|method|StandardImmutableDirectedGraphTest ( boolean allowsSelfLoops, ElementOrder<Integer> incidentEdgeOrder)
specifier|public
name|StandardImmutableDirectedGraphTest
parameter_list|(
name|boolean
