...
begin_comment
comment|/** Tests for a directed {@link StandardMutableNetwork} allowing self-loops. */
end_comment
...
name|class
argument_list|)
DECL|class|StandardMutableDirectedNetworkTest
specifier|public
class|class
...
decl_stmt|;
DECL|method|StandardMutableDirectedNetworkTest (boolean allowsSelfLoops)
specifier|public
name|StandardMutableDirectedNetworkTest
parameter_list|(
name|boolean
