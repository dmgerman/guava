...
begin_comment
comment|/** Tests for an undirected {@link StandardMutableNetwork}. */
end_comment
...
name|edgeOrder
decl_stmt|;
DECL|method|StandardMutableUndirectedNetworkTest ( boolean allowsSelfLoops, boolean allowsParallelEdges, ElementOrder<Integer> nodeOrder, ElementOrder<String> edgeOrder)
specifier|public
name|StandardMutableUndirectedNetworkTest
parameter_list|(
name|boolean
