...
name|IoTestCase
block|{
DECL|method|testCopy_channel ()
specifier|public
name|void
name|testCopy_channel
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testCopy_channel_fromFile ()
specifier|public
name|void
name|testCopy_channel_fromFile
parameter_list|()
throws|throws
name|IOException
block|{
...
literal|14407
decl_stmt|;
comment|// Random prime, unlikely to match any internal chunk size
name|ByteArrayOutputStream
name|out
init|=
operator|new
...
block|}
block|}
DECL|method|testCopy_stream ()
specifier|public
name|void
name|testCopy_stream
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testCopy_stream_files_emptyDestination ()
specifier|public
name|void
name|testCopy_stream_files_emptyDestination
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testCopy_stream_files_appendDestination ()
specifier|public
name|void
name|testCopy_stream_files_appendDestination
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testCopy_stream_files_additionalWrites_emptyDestination ()
specifier|public
name|void
name|testCopy_stream_files_additionalWrites_emptyDestination
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testCopy_stream_files_additionalWrites_appendDestination ()
specifier|public
name|void
name|testCopy_stream_files_additionalWrites_appendDestination
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testNewDataInput_BAIS ()
specifier|public
name|void
name|testNewDataInput_BAIS
parameter_list|()
block|{
name|ByteArrayInputStream
name|bais
...
expr_stmt|;
block|}
comment|// Hardcoded because of Android problems. See testUtf16Expected.
DECL|field|utf16ExpectedWithBom
specifier|private
specifier|static
specifier|final
name|byte
index|[]
name|utf16ExpectedWithBom
init|=
operator|new
name|byte
index|[]
...
comment|// https://code.google.com/p/android/issues/detail?id=196848
DECL|method|testUtf16Expected ()
specifier|public
name|void
name|testUtf16Expected
parameter_list|()
block|{
name|byte
index|[]
name|hardcodedExpected
init|=
name|utf16ExpectedWithBom
decl_stmt|;
name|byte
index|[]
name|computedExpected
init|=
literal|"r\u00C9sum\u00C9"
operator|.
name|getBytes
...
expr_stmt|;
block|}
DECL|method|testNewDataOutput_BAOS ()
specifier|public
name|void
name|testNewDataOutput_BAOS
parameter_list|()
block|{
name|ByteArrayOutputStream
name|baos
...
expr_stmt|;
block|}
DECL|method|testToByteArray_emptyStream ()
specifier|public
name|void
name|testToByteArray_emptyStream
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testToByteArray_largeStream ()
specifier|public
name|void
name|testToByteArray_largeStream
parameter_list|()
throws|throws
name|IOException
block|{
comment|// well, large enough to require multiple buffers
name|byte
index|[]
name|expected
init|=
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenCorrectSize ()
specifier|public
name|void
name|testToByteArray_withSize_givenCorrectSize
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenSmallerSize ()
specifier|public
name|void
name|testToByteArray_withSize_givenSmallerSize
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenLargerSize ()
specifier|public
name|void
name|testToByteArray_withSize_givenLargerSize
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenSizeZero ()
specifier|public
name|void
name|testToByteArray_withSize_givenSizeZero
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenSizeOneSmallerThanActual ()
specifier|public
name|void
name|testToByteArray_withSize_givenSizeOneSmallerThanActual
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// this results in toByteArrayInternal being called when the stream is actually exhausted
name|byte
index|[]
name|b
init|=
...
expr_stmt|;
block|}
DECL|method|testToByteArray_withSize_givenSizeTwoSmallerThanActual ()
specifier|public
name|void
name|testToByteArray_withSize_givenSizeTwoSmallerThanActual
parameter_list|()
throws|throws
name|IOException
block|{
