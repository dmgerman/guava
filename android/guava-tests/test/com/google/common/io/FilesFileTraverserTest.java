...
begin_comment
comment|/**  * Tests for {@link Files#fileTraverser()}.  *  * @author Jens Nyman  */
end_comment

begin_class
DECL|class|FilesFileTraverserTest
specifier|public
class|class
name|FilesFileTraverserTest
extends|extends
name|TestCase
block|{
DECL|field|rootDir
...
name|IOException
block|{
comment|// delete rootDir and its contents
name|java
operator|.
name|nio
operator|.
