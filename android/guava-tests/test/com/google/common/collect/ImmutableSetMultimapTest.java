...
begin_comment
comment|/**  * Tests for {@link ImmutableSetMultimap}.  *  * @author Mike Ward  */
end_comment
...
literal|true
argument_list|)
DECL|class|ImmutableSetMultimapTest
specifier|public
class|class
name|ImmutableSetMultimapTest
extends|extends
name|TestCase
block|{
DECL|class|ImmutableSetMultimapGenerator
specifier|private
specifier|static
specifier|final
class|class
name|ImmutableSetMultimapGenerator
extends|extends
name|TestStringSetMultimapGenerator
block|{
annotation|@
...
block|}
block|}
DECL|class|ImmutableSetMultimapCopyOfEntriesGenerator
specifier|private
specifier|static
specifier|final
class|class
name|ImmutableSetMultimapCopyOfEntriesGenerator
extends|extends
name|TestStringSetMultimapGenerator
block|{
annotation|@
...
name|named
argument_list|(
literal|"ImmutableSetMultimap.copyOf[Iterable<Entry>]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testCopyOfImmutableSetMultimap ()
specifier|public
name|void
name|testCopyOfImmutableSetMultimap
parameter_list|()
block|{
name|Multimap
argument_list|<
...
block|{     }
block|}
comment|// TODO(b/172823566): Use mainline testToImmutableSetMultimap once CollectorTester is usable.
DECL|method|testToImmutableSetMultimap_java7_combine ()
specifier|public
name|void
name|testToImmutableSetMultimap_java7_combine
parameter_list|()
block|{
name|ImmutableSetMultimap
operator|.
...
name|GwtIncompatible
comment|// SerializableTester
DECL|method|testSortedSerialization ()
specifier|public
name|void
name|testSortedSerialization
parameter_list|()
block|{
name|Multimap
argument_list|<
