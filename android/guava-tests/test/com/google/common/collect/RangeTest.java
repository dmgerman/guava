...
argument_list|)
decl_stmt|;
comment|// first range open end, second range open start
name|assertEquals
argument_list|(
name|Range
operator|.
...
argument_list|)
expr_stmt|;
comment|// first range closed end, second range open start
name|assertEquals
argument_list|(
name|Range
operator|.
...
argument_list|)
expr_stmt|;
comment|// first range open end, second range closed start
name|assertEquals
argument_list|(
name|Range
operator|.
...
argument_list|)
expr_stmt|;
comment|// first range closed end, second range closed start
name|assertEquals
argument_list|(
name|Range
operator|.
...
expr_stmt|;
block|}
comment|// TODO(cpovirk): More extensive testing of gap().
