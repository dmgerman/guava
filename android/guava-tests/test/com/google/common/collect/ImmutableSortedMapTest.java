...
operator|.
name|ImmutableSortedMapCopyOfEntriesGenerator
import|;
end_import
...
name|named
argument_list|(
literal|"ImmutableSortedMap.copyOf[Iterable<Entry>]"
argument_list|)
operator|.
name|createTestSuite
argument_list|()
...
name|named
argument_list|(
literal|"ImmutableSortedMap.entrySet.asList"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"ImmutableSortedMap.keySet.asList"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
name|named
argument_list|(
literal|"ImmutableSortedMap.values.asList"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
expr_stmt|;
block|}
comment|// TODO(b/172823566): Use mainline testToImmutableSortedMap once CollectorTester is usable.
DECL|method|testToImmutableSortedMap_java7_combine ()
specifier|public
name|void
name|testToImmutableSortedMap_java7_combine
parameter_list|()
block|{
name|ImmutableSortedMap
operator|.
...
block|}
comment|// TODO(b/172823566): Use mainline testToImmutableSortedMap once CollectorTester is usable.
DECL|method|testToImmutableSortedMap_exceptionOnDuplicateKey_java7_combine ()
specifier|public
name|void
name|testToImmutableSortedMap_exceptionOnDuplicateKey_java7_combine
parameter_list|()
block|{
name|ImmutableSortedMap
operator|.
...
name|fail
argument_list|(
literal|"Expected NullPointerException in copyOf("
operator|+
name|source
operator|+
literal|")"
