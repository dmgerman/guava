...
block|}
block|}
DECL|class|ImmutableListMultimapCopyOfEntriesGenerator
specifier|public
specifier|static
class|class
name|ImmutableListMultimapCopyOfEntriesGenerator
extends|extends
name|TestStringListMultimapGenerator
block|{
annotation|@
...
name|named
argument_list|(
literal|"ImmutableListMultimap.copyOf[Iterable<Entry>]"
argument_list|)
operator|.
name|withFeatures
argument_list|(
...
block|{     }
block|}
comment|// TODO(b/172823566): Use mainline testToImmutableListMultimap once CollectorTester is usable.
DECL|method|testToImmutableListMultimap_java7_combine ()
specifier|public
name|void
name|testToImmutableListMultimap_java7_combine
parameter_list|()
block|{
name|ImmutableListMultimap
operator|.
