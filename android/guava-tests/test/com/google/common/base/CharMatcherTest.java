...
expr_stmt|;
block|}
comment|// The rest of the behavior of ANY and DEFAULT will be covered in the tests for
...
literal|"deprecation"
argument_list|)
comment|// intentionally testing apply() method
...
expr_stmt|;
block|}
DECL|method|assertToStringWorks (String expected, CharMatcher matcher)
specifier|private
specifier|static
name|void
name|assertToStringWorks
