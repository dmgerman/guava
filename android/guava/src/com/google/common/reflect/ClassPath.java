...
argument_list|)
decl_stmt|;
comment|// Add all locations to the scanned set so that in a classpath [jar1, jar2], where jar1 has a
comment|// manifest with Class-Path pointing to jar2, we won't scan jar2 twice.
name|Set
argument_list|<
name|File
argument_list|>
...
block|}
block|}
comment|/**    * Returns all locations that {@code classloader} and parent loaders load classes and resources    * from. Callers can {@linkplain LocationInfo#scanResources scan} individual locations selectively    * or even in parallel.    */
DECL|method|locationsFrom (ClassLoader classloader)
specifier|static
name|ImmutableSet
argument_list|<
name|LocationInfo
...
return|;
block|}
comment|/**    * Represents a single location (a directory or a jar file) in the class path and is responsible    * for scanning resources from this location.    */
DECL|class|LocationInfo
specifier|static
specifier|final
class|class
name|LocationInfo
...
name|classloader
decl_stmt|;
DECL|method|LocationInfo (File home, ClassLoader classloader)
name|LocationInfo
parameter_list|(
name|File
name|home
...
expr_stmt|;
block|}
comment|/** Returns the file this location is from. */
DECL|method|file ()
specifier|public
specifier|final
name|File
...
return|;
block|}
comment|/** Scans this location and returns all scanned resources. */
DECL|method|scanResources ()
specifier|public
name|ImmutableSet
argument_list|<
name|ResourceInfo
...
return|;
block|}
DECL|method|scan (File file, Set<File> scannedUris, ImmutableSet.Builder<ResourceInfo> builder)
specifier|private
name|void
name|scan
parameter_list|(
...
block|}
block|}
DECL|method|scanJar ( File file, Set<File> scannedUris, ImmutableSet.Builder<ResourceInfo> builder)
specifier|private
name|void
name|scanJar
parameter_list|(
...
control|)
block|{
comment|// We only scan each file once independent of the classloader that file might be
...
block|}
block|}
DECL|method|scanJarFile (JarFile file, ImmutableSet.Builder<ResourceInfo> builder)
specifier|private
name|void
name|scanJarFile
parameter_list|(
...
block|}
block|}
DECL|method|scanDirectory (File directory, ImmutableSet.Builder<ResourceInfo> builder)
specifier|private
name|void
name|scanDirectory
parameter_list|(
...
DECL|method|scanDirectory ( File directory, String packagePrefix, Set<File> currentPath, ImmutableSet.Builder<ResourceInfo> builder)
specifier|private
name|void
name|scanDirectory
parameter_list|(
