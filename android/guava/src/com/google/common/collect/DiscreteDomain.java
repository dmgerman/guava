...
annotation|@
name|Override
DECL|method|offset (Integer origin, long distance)
name|Integer
name|offset
parameter_list|(
name|Integer
...
annotation|@
name|Override
DECL|method|offset (Long origin, long distance)
name|Long
name|offset
parameter_list|(
name|Long
...
annotation|@
name|Override
DECL|method|offset (BigInteger origin, long distance)
name|BigInteger
name|offset
parameter_list|(
name|BigInteger
...
expr_stmt|;
block|}
comment|/** Private constructor for built-in DiscreteDomains supporting fast offset. */
DECL|method|DiscreteDomain (boolean supportsFastOffset)
specifier|private
name|DiscreteDomain
parameter_list|(
name|boolean
