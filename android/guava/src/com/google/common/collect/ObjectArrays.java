...
begin_comment
comment|/**  * Static utility methods pertaining to object arrays.  *  * @author Kevin Bourrillion  * @since 2.0  */
end_comment
...
annotation|@
name|CanIgnoreReturnValue
DECL|method|checkElementsNotNull (@ullable Object[] array, int length)
specifier|static
annotation|@
name|Nullable
name|Object
...
annotation|@
name|CanIgnoreReturnValue
DECL|method|checkElementNotNull (@heckForNull Object element, int index)
specifier|static
name|Object
name|checkElementNotNull
parameter_list|(
