...
argument_list|()
decl_stmt|;
comment|/**    * The hashtable. Its values are indexes to the keys, values, and entries arrays.    *    *<p>Currently, the UNSET value means "null pointer", and any positive value x is the actual    * index + 1.    *    *<p>Its size must be a power of two.    */
DECL|field|table
annotation|@
name|MonotonicNonNullDecl
specifier|private
