...
expr_stmt|;
block|}
comment|/**    * Constructs a new instance of {@code CompactHashMap} with the specified capacity and load    * factor.    *    * @param capacity the initial capacity of this {@code CompactHashMap}.    * @param loadFactor the load factor of this {@code CompactHashMap}.    */
DECL|method|CompactHashMap (int capacity, float loadFactor)
name|CompactHashMap
parameter_list|(
name|int
name|capacity
