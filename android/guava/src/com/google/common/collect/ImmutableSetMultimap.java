...
annotation|@
name|Override
DECL|method|newMutableValueCollection ()
name|Collection
argument_list|<
name|V
argument_list|>
name|newMutableValueCollection
parameter_list|()
block|{
return|return
name|Platform
...
annotation|@
name|Override
DECL|method|combine (ImmutableMultimap.Builder<K, V> other)
name|Builder
argument_list|<
name|K
argument_list|,
...
name|inverse
decl_stmt|;
comment|/**    * {@inheritDoc}    *    *<p>Because an inverse of a set multimap cannot contain multiple pairs with the same key and    * value, this method returns an {@code ImmutableSetMultimap} rather than the {@code    * ImmutableMultimap} specified in the {@code ImmutableMultimap} class.    */
annotation|@
name|Override
DECL|method|inverse ()
specifier|public
