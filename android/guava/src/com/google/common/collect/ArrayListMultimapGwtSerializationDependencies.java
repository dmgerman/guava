...
literal|true
argument_list|)
DECL|class|ArrayListMultimapGwtSerializationDependencies
specifier|abstract
class|class
...
argument_list|>
block|{
DECL|method|ArrayListMultimapGwtSerializationDependencies (Map<K, Collection<V>> map)
name|ArrayListMultimapGwtSerializationDependencies
parameter_list|(
name|Map
argument_list|<
...
expr_stmt|;
block|}
comment|// TODO(cpovirk): Maybe I should have just one shared superclass for AbstractMultimap itself?
block|}
end_class
