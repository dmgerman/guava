...
literal|"Host"
decl_stmt|;
comment|/**    * The HTTP<a href="https://tools.ietf.org/html/rfc7540#section-3.2.1">{@code HTTP2-Settings}    *</a> header field name.    *    * @since 24.0    */
...
block|{
DECL|method|ReferrerPolicyValues ()
specifier|private
name|ReferrerPolicyValues
parameter_list|()
block|{}
DECL|field|NO_REFERRER
specifier|public
specifier|static
specifier|final
name|String
...
literal|"no-referrer"
decl_stmt|;
DECL|field|NO_REFFERER_WHEN_DOWNGRADE
specifier|public
specifier|static
specifier|final
name|String
name|NO_REFFERER_WHEN_DOWNGRADE
init|=
literal|"no-referrer-when-downgrade"
decl_stmt|;
DECL|field|SAME_ORIGIN
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|ORIGIN_WHEN_CROSS_ORIGIN
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|STRICT_ORIGIN_WHEN_CROSS_ORIGIN
specifier|public
specifier|static
specifier|final
name|String
...
DECL|field|X_CONTENT_SECURITY_POLICY_REPORT_ONLY
specifier|public
specifier|static
specifier|final
name|String
name|X_CONTENT_SECURITY_POLICY_REPORT_ONLY
init|=
literal|"X-Content-Security-Policy-Report-Only"
decl_stmt|;
comment|/**    * The HTTP nonstandard {@code X-WebKit-CSP} header field name. It was introduced in<a    * href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by the Chrome until    * version 25. Please, use {@link #CONTENT_SECURITY_POLICY} to pass the CSP.    *    * @since 20.0    */
DECL|field|X_WEBKIT_CSP
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
comment|/**    * The HTTP nonstandard {@code X-WebKit-CSP-Report-Only} header field name. It was introduced in    *<a href="https://www.w3.org/TR/2011/WD-CSP-20111129/">CSP v.1</a> and used by the Chrome until    * version 25. Please, use {@link #CONTENT_SECURITY_POLICY_REPORT_ONLY} to pass the CSP.    *    * @since 20.0    */
DECL|field|X_WEBKIT_CSP_REPORT_ONLY
specifier|public
specifier|static
specifier|final
name|String
name|X_WEBKIT_CSP_REPORT_ONLY
init|=
...
specifier|final
name|String
name|SEC_PROVIDED_TOKEN_BINDING_ID
init|=
...
specifier|final
name|String
name|SEC_REFERRED_TOKEN_BINDING_ID
init|=
