...
argument_list|()
decl_stmt|;
DECL|method|DepthFirstPreOrderIterator (N root)
name|DepthFirstPreOrderIterator
parameter_list|(
name|N
name|root
...
argument_list|()
decl_stmt|;
DECL|method|DepthFirstPostOrderIterator (N root)
name|DepthFirstPostOrderIterator
parameter_list|(
name|N
name|root
...
name|childIterator
decl_stmt|;
DECL|method|NodeAndChildren (N node, Iterable<? extends N> children)
name|NodeAndChildren
parameter_list|(
name|N
name|node
