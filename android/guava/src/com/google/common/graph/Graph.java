...
name|DoNotMock
argument_list|(
literal|"Use GraphBuilder to create a real instance"
argument_list|)
...
parameter_list|()
function_decl|;
comment|/**    * Returns an {@link ElementOrder} that specifies the order of iteration for the elements of    * {@link #edges()}, {@link #adjacentNodes(Object)}, {@link #predecessors(Object)}, {@link    * #successors(Object)} and {@link #incidentEdges(Object)}.    *    * @since 29.0    */
annotation|@
name|Override
