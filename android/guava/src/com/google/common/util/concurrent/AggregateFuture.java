...
block|}
block|}
DECL|method|decrementCountAndMaybeComplete ( @ullableDecl ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion)
specifier|private
name|void
name|decrementCountAndMaybeComplete
parameter_list|(
...
block|}
block|}
DECL|method|processCompleted ( @ullableDecl ImmutableCollection<? extends Future<? extends InputT>> futuresIfNeedToCollectAtCompletion)
specifier|private
name|void
name|processCompleted
parameter_list|(
...
DECL|method|collectOneValue (int index, @NullableDecl InputT returnValue)
specifier|abstract
name|void
name|collectOneValue
parameter_list|(
