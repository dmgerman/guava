...
DECL|method|maybePropagateCancellation ( @ullable ListenableFuture<?> from, @Nullable Future<?> to)
specifier|private
specifier|static
name|void
...
parameter_list|)
block|{
comment|// AbstractFuture can propagate the mayInterruptIfRunning bit.
if|if
condition|(
name|from
operator|instanceof
...
block|}
block|}
DECL|class|CancellationPropagater
specifier|private
specifier|static
specifier|final
class|class
name|CancellationPropagater
implements|implements
name|Runnable
block|{
DECL|field|from
...
name|to
decl_stmt|;
DECL|method|CancellationPropagater (ListenableFuture<?> from, Future<?> to)
name|CancellationPropagater
parameter_list|(
name|ListenableFuture
argument_list|<
