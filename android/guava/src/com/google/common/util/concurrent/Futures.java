...
argument_list|)
block|;
comment|// allAsList ensures that it fills the output list with V instances.
block|@
name|SuppressWarnings
argument_list|(
literal|"nullness"
...
name|incompleteOutputCount
block|;
comment|// We set the elements of the array to null as they complete.
...
argument_list|)
block|{
comment|/*        * requireNonNull is safe because we accepted an Iterable of non-null Future instances, and we        * don't overwrite an element in the array until after reading it.        */
name|ListenableFuture
argument_list|<
name|?
extends|extends
