...
parameter_list|()
block|{
comment|/*      * We'd normally use ServiceLoader here, but it hurts Android startup performance. To avoid      * that, we hardcode the JDK Pattern compiler on Android (and, inadvertently, on App Engine and      * in Guava, at least for now).      */
return|return
operator|new
name|JdkPatternCompiler
argument_list|()
