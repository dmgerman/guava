...
expr_stmt|;
block|}
comment|// inherit: isEmpty, containsAll, toArray x2, iterator, listIterator, mutations
annotation|@
name|Override
DECL|method|size ()
specifier|public
...
block|}
block|}
comment|/**    * Returns {@code true} if {@code object} is an {@code ImmutableLongArray} containing the same    * values as this one, in the same order.    */
annotation|@
name|Override
DECL|method|equals (@ullable Object object)
specifier|public
