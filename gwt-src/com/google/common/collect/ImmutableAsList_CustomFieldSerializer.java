...
begin_comment
comment|/**  * This class implements the server-side GWT serialization of  * {@link ImmutableAsList}.  *  * @author Hayward Chan  */
end_comment
...
block|{
DECL|method|deserialize (SerializationStreamReader reader, ImmutableAsList<?> instance)
specifier|public
specifier|static
name|void
name|deserialize
...
return|;
block|}
DECL|method|serialize (SerializationStreamWriter writer, ImmutableAsList<?> instance)
specifier|public
specifier|static
name|void
name|serialize
