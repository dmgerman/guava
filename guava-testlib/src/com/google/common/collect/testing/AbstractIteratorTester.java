...
comment|// This class is accessible but not supported in GWT.
...
decl_stmt|;
DECL|method|PermittedMetaException ( Collection<? extends Class<? extends RuntimeException>> exceptionClasses)
specifier|private
name|PermittedMetaException
parameter_list|(
name|Collection
...
expr_stmt|;
block|}
DECL|method|PermittedMetaException (Class<? extends RuntimeException> exceptionClass)
specifier|private
name|PermittedMetaException
parameter_list|(
name|Class
...
expr_stmt|;
block|}
comment|// It's not supported In GWT, it always returns true.
...
return|;
block|}
comment|// It's not supported in GWT, it always passes.
