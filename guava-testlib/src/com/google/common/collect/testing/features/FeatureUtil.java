...
parameter_list|)
block|{
comment|// The base case of the recursion is an empty set of features, which will
comment|// occur when the previous set contained only simple features.
if|if
condition|(
operator|!
name|features
...
comment|// Calls generic varargs method.
annotation|@
...
return|;
block|}
comment|/**    * Construct a new {@link java.util.Set} that is the intersection    * of all the given sets.    * @param sets the sets to intersect    * @return the intersection of the sets    * @throws java.lang.IllegalArgumentException if there are no sets to    *         intersect    */
DECL|method|intersection (Set<? extends T> .... sets)
specifier|public
specifier|static
parameter_list|<
name|T
...
name|IllegalArgumentException
argument_list|(
literal|"Can't intersect no sets; would have to return the universe."
argument_list|)
throw|;
block|}
name|Set
