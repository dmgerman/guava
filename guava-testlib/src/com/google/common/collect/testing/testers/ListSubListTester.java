...
begin_comment
comment|/**  * A generic JUnit test which tests {@code subList()} operations on a list.  * Can't be invoked directly; please see  * {@link com.google.common.collect.testing.ListTestSuiteBuilder}.  *  *<p>This class is GWT compatible.  *  * @author Chris Povirk  */
end_comment
...
name|class
argument_list|,
literal|"testSubList_originalListSetAffectsSubList"
argument_list|)
return|;
block|}
...
name|class
argument_list|,
literal|"testSubList_originalListSetAffectsSubListLargeList"
argument_list|)
return|;
block|}
...
name|class
argument_list|,
literal|"testSubList_subListRemoveAffectsOriginalLargeList"
argument_list|)
return|;
block|}
