...
begin_comment
comment|/**  * A generic JUnit test which tests {@code retainAll} operations on a list.  * Can't be invoked directly; please see  * {@link com.google.common.collect.testing.ListTestSuiteBuilder}.  *  * @author Chris Povirk  */
end_comment
...
name|SEVERAL
argument_list|)
DECL|method|testRetainAll_countIgnored ()
specifier|public
name|void
name|testRetainAll_countIgnored
parameter_list|()
block|{
name|resetContainer
argument_list|(
