...
begin_comment
comment|/**  * A generic JUnit test which tests operations on a NavigableSet. Can't be  * invoked directly; please see {@code SetTestSuiteBuilder}.  *  * @author Jesse Wilson  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|SetNavigationTester
specifier|public
class|class
name|SetNavigationTester
parameter_list|<
name|E
parameter_list|>
extends|extends
