...
expr_stmt|;
block|}
comment|/**    * Returns the {@link Method} instance for the test that assumes the entries iterator supports     * {@code remove()}.    */
annotation|@
name|GwtIncompatible
argument_list|(
literal|"reflection"
argument_list|)
DECL|method|getIteratorRemoveMethod ()
specifier|public
specifier|static
name|Method
...
name|class
argument_list|,
literal|"testIteratorRemovePropagatesToMultimap"
argument_list|)
return|;
block|}
block|}
