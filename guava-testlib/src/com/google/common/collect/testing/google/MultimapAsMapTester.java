...
expr_stmt|;
block|}
comment|/**    * Returns the {@link Method} instance for the test that assumes the asMap().entrySet() iterator    * supports {@code remove()} so that the test for {@code Multimaps.filter} can suppress it.    */
annotation|@
name|GwtIncompatible
argument_list|(
literal|"reflection"
argument_list|)
DECL|method|getAsMapEntrySetIteratorRemoveMethod ()
specifier|public
specifier|static
name|Method
...
name|class
argument_list|,
literal|"testAsMapEntrySetIteratorRemovePropagatesToMultimap"
argument_list|)
return|;
block|}
block|}
