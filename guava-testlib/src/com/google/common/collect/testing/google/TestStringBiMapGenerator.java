...
begin_comment
comment|/**  * Implementation helper for {@link TestBiMapGenerator} for use with bimaps of  * strings.  *  *<p>This class is GWT compatible.  *  * @author Chris Povirk  * @author Jared Levy  * @author George van den Driessche  * @author Louis Wasserman  */
end_comment

begin_class
annotation|@
name|GwtCompatible
DECL|class|TestStringBiMapGenerator
specifier|public
specifier|abstract
class|class
