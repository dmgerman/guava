...
begin_comment
comment|/**  * Creates, based on your criteria, a JUnit test suite that exhaustively tests  * a {@code SortedSetMultimap} implementation.  *  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|SortedSetMultimapTestSuiteBuilder
specifier|public
class|class
