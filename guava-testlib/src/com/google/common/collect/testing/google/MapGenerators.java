...
block|}
block|}
DECL|class|ImmutableMapValuesAsSingletonSetGenerator
specifier|public
specifier|static
class|class
...
return|;
block|}
comment|// javac7 can't infer the type parameters correctly in samples()
DECL|method|collectionOf (int item)
specifier|private
specifier|static
name|Collection
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// assumes that each set is a singleton or less (as is done for the samples)
for|for
control|(
name|Object
name|elem
...
literal|"unchecked"
argument_list|)
comment|// safe by generator contract
name|Entry
argument_list|<
name|String
argument_list|,
...
annotation|@
name|Override
DECL|method|order ( List<Entry<String, Collection<Integer>>> insertionOrder)
specifier|public
name|Iterable
argument_list|<
name|Entry
