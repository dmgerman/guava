...
return|;
block|}
comment|/**    * Calls the smallest subMap overload that filters out the extreme values. This method is    * overridden by NavigableMapTestSuiteBuilder.    */
DECL|method|createSubMap (SortedMap<K, V> map, K firstInclusive, K firstExclusive, K lastExclusive, K lastInclusive, Bound from, Bound to)
name|SortedMap
argument_list|<
name|K
argument_list|,
...
DECL|method|newBuilderUsing (TestMapGenerator<K, V> generator)
name|SortedMapTestSuiteBuilder
argument_list|<
name|K
argument_list|,
