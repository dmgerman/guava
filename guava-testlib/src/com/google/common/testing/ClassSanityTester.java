...
return|;
block|}
comment|/**    * Tests that {@code cls} properly checks null on all constructor and method parameters that    * aren't annotated with {@link Nullable}. In details:    *<ul>    *<li>All public static methods are checked such that passing null for any parameter that's not    *     annotated with {@link javax.annotation.Nullable} should throw {@link NullPointerException}.    *<li>If there is any public constructor or public static factory method declared by {@code cls},    *     all public instance methods will be checked too using the instance created by invoking the    *     constructor or static factory method.    *<li>If there is any public constructor or public static factory method declared by {@code cls}:    *<ul>    *<li>Test will fail if default value for a parameter cannot be determined.    *<li>Test will fail if the factory method returns null so testing instance methods is    *         impossible.    *<li>Test will fail if the constructor or factory method throws exception.    *</ul>    *<li>If there is no public constructor or public static factory method declared by {@code cls},    *     instance methods are skipped for nulls test.    *<li>Nulls test is not performed on method return values unless the method is a public static    *     factory method whose return type is {@code cls} or {@code cls}'s subtype.    *</ul>    */
...
block|}
block|}
comment|/**    * Tests the {@link Object#equals} and {@link Object#hashCode} of {@code cls}. In details:    *<ul>    *<li>The public constructor or public static factory method with the most parameters is used to    *     construct the sample instances. In case of tie, the candidate constructors or factories are    *     tried one after another until one can be used to construct sample instances.    *<li>For the constructor or static factory method used to construct instances, it's checked that    *     when equal parameters are passed, the result instance should also be equal; and vice versa.    *<li>If a public constructor or public static factory method exists:<ul>    *<li>Test will fail if default value for a parameter cannot be determined.    *<li>Test will fail if the factory method returns null so testing instance methods is    *         impossible.    *<li>Test will fail if the constructor or factory method throws exception.    *</ul>    *<li>If there is no public constructor or public static factory method declared by {@code cls},    *     no test is performed.    *<li>Equality test is not performed on method return values unless the method is a public static    *     factory method whose return type is {@code cls} or {@code cls}'s subtype.    *<li>Inequality check is not performed against state mutation methods such as {@link List#add},    *     or functional update methods such as {@link com.google.common.base.Joiner#skipNulls}.    *</ul>    */
...
expr_stmt|;
block|}
comment|/**    * Instantiates {@code cls} by invoking one of its public constructors or public static factory    * methods with the parameters automatically provided using dummy values.    *    * @return The instantiated instance, or {@code null} if the class has no public constructor    *         or factory method to be constructed.    */
...
name|factories
decl_stmt|;
DECL|method|FactoryMethodReturnValueTester (ImmutableList<Invokable<?, ?>> factories)
specifier|private
name|FactoryMethodReturnValueTester
parameter_list|(
name|ImmutableList
