...
parameter_list|()
block|{
comment|// miscellaneous value types
name|setDefault
argument_list|(
name|Object
operator|.
...
argument_list|)
expr_stmt|;
comment|// TODO(benyu): should this be ImmutableSortedSet? Not type safe.
name|setDefault
argument_list|(
name|SortedSet
operator|.
...
argument_list|)
expr_stmt|;
comment|// The following 3 aren't really safe generically
comment|// For example, Comparable<String> can't be 0
name|setDefault
argument_list|(
name|Comparable
operator|.
...
argument_list|)
expr_stmt|;
comment|// TODO(benyu): We would have delegated to Defaults.getDefault()
comment|// By changing it now risks breaking existing clients, and we don't really
comment|// care the default value anyway.
name|setDefault
argument_list|(
name|char
operator|.
...
return|;
block|}
DECL|method|getDefaultValue (Class<T> type)
specifier|private
parameter_list|<
name|T
parameter_list|>
