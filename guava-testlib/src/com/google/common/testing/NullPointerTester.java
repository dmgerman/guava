...
block|}
block|}
comment|/**    * Verifies that {@code ctor} produces a {@link NullPointerException} or {@link    * UnsupportedOperationException} whenever<i>any</i> of its non-nullable parameters are null.    */
...
expr_stmt|;
block|}
comment|/**    * Verifies that {@code ctor} produces a {@link NullPointerException} or {@link    * UnsupportedOperationException} when the parameter in position {@code paramIndex} is null. If    * this parameter is marked nullable, this method does nothing.    */
...
block|}
block|}
comment|/**    * Verifies that {@code invokable} produces a {@link NullPointerException} or {@link    * UnsupportedOperationException} when the parameter in position {@code paramIndex} is null. If    * this parameter is marked nullable, this method does nothing.    *    * @param instance the instance to invoke {@code invokable} on, or null if {@code invokable} is    *     static    */
...
argument_list|)
decl_stmt|;
DECL|method|isNullable (Invokable<?, ?> invokable)
specifier|static
name|boolean
name|isNullable
parameter_list|(
...
return|;
block|}
DECL|method|isNullableTypeVariable (Type type)
specifier|private
specifier|static
name|boolean
name|isNullableTypeVariable
...
return|;
block|}
DECL|method|isNullable (Annotation[] annotations)
specifier|private
specifier|static
name|boolean
name|isNullable
...
return|;
block|}
comment|// This is currently required because of j2objc restrictions.
DECL|field|GET_ANNOTATED_BOUNDS
specifier|private
specifier|static
specifier|final
name|Function
...
name|GET_ANNOTATED_BOUNDS
init|=
name|initGetAnnotatedBounds
argument_list|()
decl_stmt|;
DECL|method|initGetAnnotatedBounds ()
specifier|private
specifier|static
name|Function
argument_list|<
