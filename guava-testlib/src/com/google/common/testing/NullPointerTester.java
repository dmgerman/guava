...
DECL|method|testMethodParameter ( final Object instance, final Method method, int paramIndex)
specifier|public
name|void
name|testMethodParameter
parameter_list|(
...
parameter_list|)
block|{
comment|// TODO(benyu): Use Invokable API once it graduates from labs.
name|Functor
name|functor
init|=
name|Functor
...
name|InstantiationException
function_decl|;
DECL|method|parameterIsPrimitiveOrNullable (int paramIndex)
name|boolean
name|parameterIsPrimitiveOrNullable
parameter_list|(
name|int
...
return|;
block|}
DECL|method|from (@ullable final Object instance, final Method method)
specifier|private
specifier|static
name|Functor
name|from
...
return|;
block|}
DECL|method|from (final Constructor<?> ctor)
specifier|private
specifier|static
name|Functor
name|from
