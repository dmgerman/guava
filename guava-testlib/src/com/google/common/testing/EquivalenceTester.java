...
argument_list|()
decl_stmt|;
DECL|method|EquivalenceTester (final Equivalence<? super T> equivalence)
name|EquivalenceTester
parameter_list|(
specifier|final
name|Equivalence
...
name|assertTrue
argument_list|(
literal|"$ITEM must be equivalent to $RELATED"
argument_list|,
name|equivalence
operator|.
name|equivalent
...
name|assertTrue
argument_list|(
literal|"$ITEM must be inequivalent to $UNRELATED"
argument_list|,
operator|!
name|equivalence
operator|.
