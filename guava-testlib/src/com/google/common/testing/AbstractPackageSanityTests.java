...
name|TestCase
block|{
comment|/**    * A predicate that matches classes with an underscore in the class name. This can be used with    * {@link #ignoreClasses} to exclude generated classes, such as the {@code AutoValue_Foo} classes    * generated by<a href="https://github.com/google/auto/tree/master/value">AutoValue</a>.    *    * @since 19.0    */
DECL|field|UNDERSCORE_IN_NAME
specifier|public
specifier|static
specifier|final
name|Predicate
