...
begin_comment
comment|/**  * Abstract test case parent for anything implementing {@link ListenableFuture}.  * Tests the two get methods and the addListener method.  *  * @author sven@google.com (Sven Mawson)  * @since Guava release 10  */
end_comment
