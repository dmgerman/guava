...
annotation|@
name|AndroidIncompatible
DECL|method|testJavaOptional ()
specifier|public
name|void
name|testJavaOptional
parameter_list|()
block|{
name|FreshValueGenerator
name|generator
...
argument_list|)
expr_stmt|;
comment|// Test that the first generated instance for different Optional<T> is always empty(). Having
comment|// generated Optional<String> instances doesn't prevent empty() from being generated for other
...
begin_function
DECL|method|testOptionalInt ()
specifier|public
name|void
name|testOptionalInt
parameter_list|()
block|{
name|assertFreshInstance
argument_list|(
...
begin_function
DECL|method|testOptionalLong ()
specifier|public
name|void
name|testOptionalLong
parameter_list|()
block|{
name|assertFreshInstance
argument_list|(
...
begin_function
DECL|method|testOptionalDouble ()
specifier|public
name|void
name|testOptionalDouble
parameter_list|()
block|{
name|assertFreshInstance
argument_list|(
...
begin_function
DECL|method|assertFreshInstance (TypeToken<?> type)
specifier|private
specifier|static
name|void
name|assertFreshInstance
...
begin_function
DECL|method|assertFreshInstance (Class<?> type, int instances)
specifier|private
specifier|static
name|void
name|assertFreshInstance
...
begin_function
DECL|method|assertFreshInstance (TypeToken<?> type, int instances)
specifier|private
specifier|static
name|void
name|assertFreshInstance
...
begin_function
DECL|method|assertCanGenerateOnly (TypeToken<?> type, Object expected)
specifier|private
specifier|static
name|void
name|assertCanGenerateOnly
...
begin_function
DECL|method|assertNotInstantiable (TypeToken<?> type)
specifier|private
specifier|static
name|void
name|assertNotInstantiable
