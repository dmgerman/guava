...
name|SIZE
decl_stmt|;
comment|/**    * The largest power of two that can be represented as a {@code short}.    *    * @since 10.0    */
...
DECL|method|toByteArray (short value)
specifier|public
specifier|static
name|byte
index|[]
...
return|;
block|}
comment|/**    * Returns the {@code short} value whose byte representation is the given 2 bytes, in big-endian    * order; equivalent to {@code Shorts.fromByteArray(new byte[] {b1, b2})}.    *    * @since 7.0    */
annotation|@
name|GwtIncompatible
comment|// doesn't work
...
annotation|@
name|Override
DECL|method|doBackward (Short value)
specifier|protected
name|String
name|doBackward
parameter_list|(
...
block|{
return|return
literal|"Shorts.stringConverter()"
return|;
block|}
...
block|{
return|return
literal|"Shorts.lexicographicalComparator()"
return|;
block|}
block|}
comment|/**    * Sorts the elements of {@code array} in descending order.    *    * @since 23.1    */
DECL|method|sortDescending (short[] array)
specifier|public
specifier|static
name|void
name|sortDescending
...
DECL|method|sortDescending (short[] array, int fromIndex, int toIndex)
specifier|public
specifier|static
name|void
name|sortDescending
...
expr_stmt|;
block|}
comment|/**    * Reverses the elements of {@code array}. This is equivalent to {@code    * Collections.reverse(Shorts.asList(array))}, but is likely to be more efficient.    *    * @since 23.1    */
DECL|method|reverse (short[] array)
specifier|public
specifier|static
name|void
name|reverse
...
expr_stmt|;
block|}
comment|/**    * Reverses the elements of {@code array} between {@code fromIndex} inclusive and {@code toIndex}    * exclusive. This is equivalent to {@code    * Collections.reverse(Shorts.asList(array).subList(fromIndex, toIndex))}, but is likely to be    * more efficient.    *    * @throws IndexOutOfBoundsException if {@code fromIndex< 0}, {@code toIndex> array.length}, or    *     {@code toIndex> fromIndex}    * @since 23.1    */
DECL|method|reverse (short[] array, int fromIndex, int toIndex)
specifier|public
specifier|static
name|void
name|reverse
