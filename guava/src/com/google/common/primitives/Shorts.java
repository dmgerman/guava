...
begin_comment
comment|/**  * Static utility methods pertaining to {@code short} primitives, that are not  * already found in either {@link Short} or {@link Arrays}.  *  * @author Kevin Bourrillion  * @since 1.0  */
end_comment
