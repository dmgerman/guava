...
begin_comment
comment|/**  * Soft reference with a {@code finalizeReferent()} method which a background thread invokes after  * the garbage collector reclaims the referent. This is a simpler alternative to using a {@link  * ReferenceQueue}.  *  * @author Bob Lee  * @since Guava release 02 (imported from Google Collections Library)  */
end_comment
