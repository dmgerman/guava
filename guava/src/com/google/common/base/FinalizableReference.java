...
begin_comment
comment|/**  * Implemented by references that have code to run after garbage collection of their referents.  *  * @see FinalizableReferenceQueue  * @author Bob Lee  * @since Guava release 02 (imported from Google Collections Library)  */
end_comment
