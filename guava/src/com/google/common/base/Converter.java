...
comment|/**    * Returns a representation of {@code a} as an instance of type {@code B}.    *    * @param a the instance to convert; will never be null    * @return the converted instance;<b>must not</b> be null    */
...
parameter_list|)
function_decl|;
comment|/**    * Returns a representation of {@code b} as an instance of type {@code A}.    *    * @param b the instance to convert; will never be null    * @return the converted instance;<b>must not</b> be null    * @throws RuntimeException if {@code b} is not an instance this converter can convert; this    *     should typically be an {@code IllegalArgumentException}    * @throws UnsupportedOperationException if this converter cannot convert in the reverse    *     direction. This should be very rare. Note that if backward conversion is not only    *     unimplemented but unimplement<i>able</i> (for example, consider a {@code    *     Converter<Chicken, ChickenNugget>}), then this is not logically a converter at all, and it    *     would be misleading to extend this class.    */
...
return|;
block|}
comment|// Static singleton converters
