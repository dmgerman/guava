...
name|INFO
argument_list|,
literal|"Using regex compiler: %s"
argument_list|,
name|patternCompiler
operator|.
name|getClass
...
argument_list|)
decl_stmt|;
comment|// Returns the first PatternCompiler that loads successfully.
try|try
block|{
for|for
control|(
...
expr_stmt|;
block|}
comment|// Fall back to the JDK regex library.
return|return
operator|new
name|JdkPatternCompiler
argument_list|()
