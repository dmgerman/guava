...
block|{
comment|// Slice off the closing brace in case there are additional calls to
comment|// #add or #addValue.
name|builder
operator|.
name|setLength
argument_list|(
...
block|}
block|}
DECL|method|maybeAppendSeparator ()
specifier|private
name|StringBuilder
name|maybeAppendSeparator
parameter_list|()
