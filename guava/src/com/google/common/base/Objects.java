...
return|;
block|}
comment|/**    * Support class for {@link Objects#toStringHelper}.    *    * @author Jason Lee    * @since 2.0    * @deprecated Use {@link MoreObjects.ToStringHelper} instead. This class is scheduled for removal    *     in Guava 21.0.    */
annotation|@
name|Deprecated
