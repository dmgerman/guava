...
return|;
block|}
DECL|method|checkNameAndAppend (String name)
specifier|private
name|StringBuilder
name|checkNameAndAppend
parameter_list|(
...
expr_stmt|;
block|}
comment|// must explicitly cast it, otherwise GWT tests might fail because
comment|// it tries to access StringBuilder.append(StringBuilder), which is
comment|// a private method
comment|// TODO(user): change once 5904010 is fixed
name|CharSequence
name|sequence
init|=
name|valueHolder
