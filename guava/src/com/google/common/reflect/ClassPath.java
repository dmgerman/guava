...
name|classloader
decl_stmt|;
DECL|method|ClassPath (ClassLoader classloader)
specifier|private
name|ClassPath
parameter_list|(
name|ClassLoader
...
expr_stmt|;
block|}
comment|/**    * Returns a {@code ClassPath} representing all classes loadable from {@code classloader} and its    * parent class loaders.    *    *<p>Currently only {@link URLClassLoader} and only {@code file://} urls are supported.    */
