...
name|classes
decl_stmt|;
DECL|method|ClassPath (ImmutableSet<ClassInfo> classes)
specifier|private
name|ClassPath
parameter_list|(
name|ImmutableSet
...
expr_stmt|;
block|}
comment|/**    * Returns a {@code ClassPath} representing all classes loadable from {@code classloader} and its    * parent class loaders.    *    *<p>Currently only {@link URLClassLoader} and only {@code file://} urls are supported.    *    * @throws IOException if the attempt to read class path resources (jar files or directories)    *         failed.    */
...
name|loader
decl_stmt|;
DECL|method|ClassInfo (String className, ClassLoader loader)
annotation|@
name|VisibleForTesting
name|ClassInfo
parameter_list|(
...
return|;
block|}
DECL|method|readClassesFrom (URI uri, ClassLoader classloader)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
...
block|}
block|}
DECL|method|readClassesFrom ( File file, ClassLoader classloader)
annotation|@
name|VisibleForTesting
specifier|static
name|ImmutableSet
...
block|}
block|}
DECL|method|readClassesFromDirectory ( File directory, ClassLoader classloader)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
...
return|;
block|}
DECL|method|readClassesFromDirectory ( File directory, ClassLoader classloader, String packagePrefix, ImmutableSet.Builder<ClassInfo> builder)
specifier|private
specifier|static
name|void
name|readClassesFromDirectory
...
block|}
block|}
DECL|method|readClassesFromJar (File file, ClassLoader classloader)
specifier|private
specifier|static
name|ImmutableSet
argument_list|<
...
block|}
block|}
DECL|method|isTopLevelClassFile (String filename)
annotation|@
name|VisibleForTesting
specifier|static
name|boolean
