...
block|}
block|}
comment|/**    * Abstract class that scans through the class path represented by a {@link ClassLoader} and calls    * {@link #onResourceFile} and {@link #onJarEntry} for each resource found on the class path.    */
DECL|class|Scanner
specifier|abstract
specifier|static
class|class
...
block|}
block|}
comment|/** Called when a resource file is scanned. */
DECL|method|onResourceFile (ClassLoader loader, String packagePath, File f)
specifier|protected
specifier|abstract
name|void
name|onResourceFile
...
return|;
block|}
DECL|method|onResourceFile ( ClassLoader classloader, String packagePath, File file)
annotation|@
name|Override
specifier|protected
name|void
