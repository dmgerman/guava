...
name|loader
decl_stmt|;
DECL|method|of (String resourceName, Collection<URL> urls, ClassLoader loader)
specifier|static
name|ResourceInfo
name|of
parameter_list|(
...
block|}
block|}
DECL|method|ResourceInfo (String resourceName, Collection<URL> urls, ClassLoader loader)
name|ResourceInfo
parameter_list|(
name|String
name|resourceName
...
expr_stmt|;
block|}
comment|/**      * Returns the url identifying the resource.      *      *<p>See {@link ClassLoader#getResource}      */
DECL|method|url ()
specifier|public
specifier|final
name|URL
...
return|;
block|}
comment|/**      * Returns all the urls for this resource.      *      *<p>See {@link ClassLoader#getResources}      */
DECL|method|urls ()
specifier|final
name|ImmutableList
argument_list|<
...
name|className
decl_stmt|;
DECL|method|ClassInfo (String resourceName, Collection<URL> urls, ClassLoader loader)
name|ClassInfo
parameter_list|(
name|String
name|resourceName
...
condition|)
block|{
comment|// The filesystem we are exploring is not a tree, we must have chased a symlink at some
comment|// point.  Just return early to avoid redundant work (or getting stuck in cycles).
return|return;
block|}
name|File
index|[]
