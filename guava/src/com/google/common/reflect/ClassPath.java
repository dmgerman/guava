...
return|;
block|}
DECL|method|browse ( URI uri, ClassLoader classloader, ImmutableSet.Builder<ResourceInfo> resources)
specifier|private
specifier|static
name|void
name|browse
...
block|}
block|}
DECL|method|browseFrom ( File file, ClassLoader classloader, ImmutableSet.Builder<ResourceInfo> resources)
annotation|@
name|VisibleForTesting
specifier|static
name|void
...
block|}
block|}
DECL|method|browseDirectory ( File directory, ClassLoader classloader, ImmutableSet.Builder<ResourceInfo> resources)
specifier|private
specifier|static
name|void
name|browseDirectory
...
expr_stmt|;
block|}
DECL|method|browseDirectory ( File directory, ClassLoader classloader, String packagePrefix, ImmutableSet.Builder<ResourceInfo> resources)
specifier|private
specifier|static
name|void
name|browseDirectory
...
block|}
block|}
DECL|method|browseJar ( File file, ClassLoader classloader, ImmutableSet.Builder<ResourceInfo> resources)
specifier|private
specifier|static
name|void
name|browseJar
