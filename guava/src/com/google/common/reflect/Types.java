...
return|;
block|}
DECL|method|containsTypeVariable (@ullable Type type)
specifier|static
name|boolean
...
return|;
block|}
DECL|method|containsTypeVariable (Type[] types)
specifier|private
specifier|static
name|boolean
name|containsTypeVariable
...
block|}
block|}
DECL|method|buildUnexpectedTypeException ( Type type, Class<?>... expected)
specifier|static
name|IllegalArgumentException
name|buildUnexpectedTypeException
parameter_list|(
name|Type
name|type
parameter_list|,
...
parameter_list|)
block|{
comment|// Build exception message
name|StringBuilder
...
name|StringBuilder
argument_list|(
literal|"Unexpected type. Expected one of: "
argument_list|)
decl_stmt|;
for|for
control|(
