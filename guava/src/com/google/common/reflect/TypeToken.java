...
return|;
block|}
comment|/**    * Returns the raw type of the class or parameterized type; if {@code T} is type variable or    * wildcard type, the raw types of all its upper bounds are returned.    */
DECL|method|getImmediateRawTypes ()
specifier|private
name|ImmutableSet
argument_list|<
name|Class
...
begin_function
DECL|method|getRawTypes (Type type)
annotation|@
name|VisibleForTesting
specifier|static
name|ImmutableSet
