...
comment|// if "to" is<? extends Foo>, nothing assignable.
return|return
name|isAssignableToAny
argument_list|(
name|from
argument_list|,
operator|(
...
return|;
block|}
comment|// if "from" is wildcard, it's assignable to "to" if any of its "extends"
...
begin_comment
comment|/** Returns true if at least one of {@code fromTypes} is subtype of {@code to}. */
end_comment
...
begin_comment
comment|/** Returns true if {@code from} is subtype of every type in {@code toTypes}. */
end_comment

begin_function
DECL|method|isAssignableToAll (Type from, Type[] toTypes)
specifier|private
specifier|static
name|boolean
name|isAssignableToAll
parameter_list|(
name|Type
name|from
parameter_list|,
...
begin_comment
comment|/** Returns true if at least one of {@code toTypes} is supertype of {@code from}. */
end_comment

begin_function
DECL|method|isAssignableToAny (Type from, Type[] toTypes)
specifier|private
specifier|static
name|boolean
name|isAssignableToAny
...
begin_comment
comment|/** Returns true if all of {@code fromTypes} are subtypes of {@code to}. */
end_comment

begin_function
DECL|method|areAssignableTo (Type[] fromTypes, Type to)
specifier|private
specifier|static
name|boolean
name|areAssignableTo
parameter_list|(
name|Type
index|[]
name|fromTypes
