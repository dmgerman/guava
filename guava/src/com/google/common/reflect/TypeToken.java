...
name|of
argument_list|(
name|replaceTypeVariablesWithWildcard
argument_list|(
name|resolvedTypeArgs
argument_list|,
name|subclass
...
return|;
block|}
DECL|method|replaceTypeVariablesWithWildcard ( Type type, final Class<?> declaringClass)
specifier|private
specifier|static
specifier|final
name|Type
...
argument_list|(
comment|// Replaces type vars on the owner type if it's owner type of declaringClass.
name|declaringClass
operator|.
...
return|;
block|}
DECL|method|replaceTypeVariablesWithWildcard ( Type[] types, Class<?> declaringClass)
specifier|private
specifier|static
specifier|final
name|Type
