...
parameter_list|)
function_decl|;
comment|/**    * Wraps a task before it is submitted to the underlying Executor.  This    * delegates to {@link #wrapTask(Callable)} by default, but should be    * overridden if there is a better implementation for {@link Runnable    * runnables}.    */
