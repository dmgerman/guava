...
return|;
block|}
comment|/**    * Returns a new {@code ListenableFuture} whose result is the product of    * applying the given {@code Function} to the result of the given {@code    * Future}. Example:    *    *<pre>   {@code    *   ListenableFuture<QueryResult> queryFuture = ...;    *   Function<QueryResult, List<Row>> rowsFunction =    *       new Function<QueryResult, List<Row>>() {    *         public List<Row> apply(QueryResult queryResult) {    *           return queryResult.getRows();    *         }    *       };    *   ListenableFuture<List<Row>> rowsFuture =    *       transform(queryFuture, rowsFunction, executor);    * }</pre>    *    *<p>The returned {@code Future} attempts to keep its cancellation state in    * sync with that of the input future. That is, if the returned {@code Future}    * is cancelled, it will attempt to cancel the input, and if the input is    * cancelled, the returned {@code Future} will receive a callback in which it    * will attempt to cancel itself.    *    *<p>An example use of this method is to convert a serializable object    * returned from an RPC into a POJO.    *    * @param future The future to compose    * @param function A Function to compose the results of the provided future    *     to the results of the returned future.    * @param exec Executor to run the function in.    * @return A future that holds result of the composition.    * @since Guava release 09 (in release 02 as {@code compose})    */
...
annotation|@
name|Beta
DECL|method|allAsList ( ListenableFuture<? extends T>.... futures)
specifier|public
specifier|static
parameter_list|<
name|T
...
annotation|@
name|Beta
DECL|method|allAsList ( Iterable<? extends ListenableFuture<? extends T>> futures)
specifier|public
specifier|static
parameter_list|<
name|T
...
annotation|@
name|Beta
DECL|method|successfulAsList ( ListenableFuture<? extends T>.... futures)
specifier|public
specifier|static
parameter_list|<
name|T
...
annotation|@
name|Beta
DECL|method|successfulAsList ( Iterable<? extends ListenableFuture<? extends T>> futures)
specifier|public
specifier|static
parameter_list|<
name|T
...
DECL|method|ListFuture ( final ImmutableList<? extends ListenableFuture<? extends T>> futures, final boolean allMustSucceed, final Executor listenerExecutor)
name|ListFuture
parameter_list|(
specifier|final
name|ImmutableList
...
DECL|method|setOneValue (int index, Future<? extends T> future)
specifier|private
name|void
name|setOneValue
parameter_list|(
