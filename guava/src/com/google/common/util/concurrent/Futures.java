...
name|Futures
block|{
comment|/**    * A 'same thread executor' that isn't an executor service and therefore cannot reject tasks.    *    *<p>Also, since it is a shared instance it should be generally cheaper and faster than    * {@link MoreExecutors#sameThreadExecutor}.    *    *<p>TODO(user): consider replacing all uses of sameThreadExecutor with this.    */
