...
begin_comment
comment|/**  * A {@link ScheduledExecutorService} that returns {@link ListenableFuture}  * instances from its {@code ExecutorService} methods.  * To create an instance from an existing {@link ScheduledExecutorService},   * call {@link MoreExecutors#listeningDecorator(ScheduledExecutorService)}.  *  * @author Chris Povirk  * @since Guava release 10  */
end_comment
...
block|{
comment|/**    * Helper interface to implement both {@link ListenableFuture} and    * {@link ScheduledFuture}.     */
