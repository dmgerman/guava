...
argument_list|()
decl_stmt|;
comment|/**    * The queue of listeners that are waiting to be executed.    *    *<p>Enqueue operations should be protected by {@link #monitor} while calling    * {@link ExecutionQueue#execute()} should not be protected.    */
...
block|}
block|}
comment|/**    * Attempts to execute all the listeners in {@link #queuedListeners} while not holding the    * {@link #monitor}.    */
