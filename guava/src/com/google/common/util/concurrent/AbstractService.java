...
argument_list|()
decl_stmt|;
comment|/**    * The queue of listeners that are waiting to be executed.    *    *<p>Enqueue operations should be protected by {@link #lock} while calling     * {@link ExecutionQueue#execute()} should not be protected.    */
