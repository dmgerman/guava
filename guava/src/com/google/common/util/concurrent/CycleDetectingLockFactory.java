...
annotation|@
name|VisibleForTesting
DECL|class|OrderedLockGraphNodesCreator
specifier|static
class|class
name|OrderedLockGraphNodesCreator
implements|implements
...
literal|"unchecked"
argument_list|)
comment|// There's no way to properly express with
comment|// wildcards the recursive Enum type required by createNodesFor(), and the
comment|// Map/Function types must use wildcards since they accept any Enum class.
DECL|method|apply ( Class<? extends Enum> clazz)
specifier|public
name|Map
argument_list|<
name|?
...
return|;
block|}
DECL|method|createNodesFor (Class<E> clazz)
parameter_list|<
name|E
extends|extends
name|Enum
...
block|}
block|}
comment|/**    * Represents a detected cycle in lock acquisition ordering. The exception    * includes a causal chain of {@code ExampleStackTrace}s to illustrate the    * cycle, e.g.    *    *<pre>    * com....PotentialDeadlockException: Potential Deadlock from LockC -&gt; ReadWriteA    *   at ...    *   at ...    * Caused by: com...ExampleStackTrace: LockB -&gt; LockC    *   at ...    *   at ...    * Caused by: com...ExampleStackTrace: ReadWriteA -&gt; LockB    *   at ...    *   at ...    *</pre>    *    * Instances are logged for the {@code Policies.WARN}, and thrown for    * {@code Policies.THROW}.    *    * @since 13.0    */
annotation|@
name|Beta
