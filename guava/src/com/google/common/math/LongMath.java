...
name|guess
decl_stmt|;
comment|// guessSquared may overflow a signed long, but may safely be treated as unsigned.
if|if
condition|(
name|x
operator|-
...
condition|)
block|{
comment|// The condition is equivalent to x>= (guess + 1) * (guess + 1), but doesn't overflow.
name|guess
operator|++
expr_stmt|;
block|}
