...
return|;
block|}
comment|/*    * This bitmask is used as an optimization for cheaply testing for divisiblity by 2, 3, or 5.    * Each bit is set to 1 for all remainders that indicate divisibility by 2, 3, or 5.    * 1, 7, 11, 13, 17, 19, 23, 29 are set to 0. 30 and up are 0 because they won't be hit.    * Bit offsets:       25    20    15    10     5     0    *            0b00_01111_10111_01011_10101_11011_11101;    * We can't actually use the binary form because it has to work in Java 6.    */
DECL|field|SIEVE_30
specifier|private
specifier|static
specifier|final
