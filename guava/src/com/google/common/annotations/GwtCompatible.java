...
begin_comment
comment|/**  * The presence of this annotation on a type indicates that the type may be used with the  *<a href="http://code.google.com/webtoolkit/">Google Web Toolkit</a> (GWT). When applied to a  * method, the return type of the method is GWT compatible. It's useful to indicate that an instance  * created by factory methods has a GWT serializable type. In the following example,  *  *<pre>  * {@literal @}GwtCompatible  * class Lists {  *   ...  *   {@literal @}GwtCompatible(serializable = true)  *   static&lt;E> List&lt;E> newArrayList(E... elements) {  *     ...  *   }  * }  *</pre>  *  *<p>The return value of {@code Lists.newArrayList(E[])} has GWT serializable type. It is also  * useful in specifying contracts of interface methods. In the following example,  *  *<pre>  * {@literal @}GwtCompatible  * interface ListFactory {  *   ...  *   {@literal @}GwtCompatible(serializable = true)  *&lt;E> List&lt;E> newArrayList(E... elements);  * }  *</pre>  *  *<p>The {@code newArrayList(E[])} method of all implementations of {@code ListFactory} is expected  * to return a value with a GWT serializable type.  *  *<p>Note that a {@code GwtCompatible} type may have some {@link GwtIncompatible} methods.  *  *  * @author Charles Fry  * @author Hayward Chan  */
end_comment
