...
begin_comment
comment|/**  * Static utility methods pertaining to {@link Escaper} instances.  *  * @author Sven Mawson  * @author David Beaumont  * @since 11.0  */
end_comment
...
parameter_list|()
block|{
comment|// TODO: Make this return an Escaper and fix callers
return|return
name|NULL_ESCAPER
return|;
block|}
