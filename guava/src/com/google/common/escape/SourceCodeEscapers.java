...
begin_comment
comment|/**  * A factory for Escaper instances used to escape strings for safe use in  * various common programming languages.  *  * @author Alex Matevossian  * @author David Beaumont  * @since 12.0  */
end_comment
