...
DECL|method|ComputingConcurrentHashMap (CacheBuilder<? super K, ? super V> builder, Supplier<? extends StatsCounter> statsCounterSupplier, CacheLoader<? super K, ? extends V> loader)
name|ComputingConcurrentHashMap
parameter_list|(
name|CacheBuilder
argument_list|<
