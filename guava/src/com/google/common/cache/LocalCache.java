...
block|}
block|}
DECL|method|loadEntry (K key, int hash, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader)
name|V
name|loadEntry
parameter_list|(
name|K
...
annotation|@
name|Nullable
DECL|method|refresh (final K key, final int hash, CacheLoader<? super K, V> loader)
name|V
name|refresh
parameter_list|(
specifier|final
...
parameter_list|)
block|{
comment|// don't let refresh exceptions propogate
name|logger
operator|.
name|log
argument_list|(
