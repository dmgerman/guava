...
DECL|method|cacheSerializationProxy (CacheLoader<? super K, V> loader)
name|Cache
argument_list|<
name|K
argument_list|,
...
name|localCache
decl_stmt|;
DECL|method|ManualLocalCache (CacheBuilder<? super K, ? super V> builder)
name|ManualLocalCache
parameter_list|(
name|CacheBuilder
argument_list|<
