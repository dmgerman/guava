...
block|}
block|}
DECL|method|loadEntry (K key, int hash, ReferenceEntry<K, V> entry, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader)
name|V
name|loadEntry
parameter_list|(
name|K
...
return|;
block|}
comment|// TODO(fry): return a map with keyEquivalence?
DECL|method|getOrLoadAll (Iterable<? extends K> keys)
name|ImmutableMap
argument_list|<
name|K
argument_list|,
...
operator|--
expr_stmt|;
comment|// getOrLoad will count this miss
name|result
operator|.
name|put
argument_list|(
