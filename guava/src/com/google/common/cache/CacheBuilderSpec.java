...
block|}
block|}
comment|/** Base class for parsing boolean values. */
...
name|ValueParser
block|{
DECL|method|parseBoolean (CacheBuilderSpec spec, boolean value)
specifier|protected
specifier|abstract
name|void
name|parseBoolean
...
name|format
argument_list|(
literal|"key %s value set to %s, must be TRUE | FALSE"
argument_list|,
name|key
argument_list|,
name|value
