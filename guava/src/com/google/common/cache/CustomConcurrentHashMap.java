...
block|}
block|}
DECL|method|waitForLoadingValue (ReferenceEntry<K, V> e, ValueReference<K, V> valueReference)
name|V
name|waitForLoadingValue
parameter_list|(
name|ReferenceEntry
...
block|}
block|}
DECL|method|load (K key, int hash, ReferenceEntry<K, V> entry, LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader)
name|V
name|load
parameter_list|(
name|K
...
comment|// detected. This may be circumvented when an entry is copied, but will fail fast most of
comment|// the time.
...
return|;
block|}
comment|/**      * Returns true if the entry has been partially collected, meaning that either the key is null,      * or the value is active but null.      */
...
block|}
block|}
DECL|method|load (K key, int hash, CacheLoader<? super K, V> loader)
name|V
name|load
parameter_list|(
name|K
...
DECL|method|cacheSerializationProxy ()
name|Cache
argument_list|<
name|K
argument_list|,
