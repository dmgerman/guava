...
begin_comment
comment|/**  * The concurrent hash map implementation built by {@link CacheBuilder}.  *  *<p>This implementation is heavily derived from revision 1.96 of<a  * href="http://tinyurl.com/ConcurrentHashMap">ConcurrentHashMap.java</a>.  *  * @author Bob Lee  * @author Charles Fry  * @author Doug Lea ({@code ConcurrentHashMap})  */
end_comment
...
name|valueStrength
decl_stmt|;
comment|/** The maximum size of this map. CacheBuilder.UNSET_INT if there is no maximum. */
...
comment|// TODO(user): define a new type which creates event objects and automates the clear logic
...
condition|)
block|{
comment|// currently CacheBuilder ensures that expireAfterWrite and
...
block|}
block|}
DECL|class|AbstractValueReference
specifier|private
specifier|static
specifier|abstract
class|class
name|AbstractValueReference
parameter_list|<
name|K
parameter_list|,
name|V
...
DECL|class|UncheckedComputationExceptionReference
specifier|private
specifier|static
specifier|final
class|class
name|UncheckedComputationExceptionReference
parameter_list|<
name|K
parameter_list|,
name|V
...
name|e
decl_stmt|;
DECL|method|UncheckedComputationExceptionReference (RuntimeException e)
name|UncheckedComputationExceptionReference
parameter_list|(
name|RuntimeException
name|e
...
name|e
decl_stmt|;
DECL|method|ComputationExceptionReference (Exception e)
name|ComputationExceptionReference
parameter_list|(
name|Exception
name|e
...
DECL|class|ComputationErrorReference
specifier|private
specifier|static
specifier|final
class|class
name|ComputationErrorReference
parameter_list|<
name|K
parameter_list|,
name|V
...
name|e
decl_stmt|;
DECL|method|ComputationErrorReference (Error e)
name|ComputationErrorReference
parameter_list|(
name|Error
name|e
