...
begin_comment
comment|/**  * Configurable implementation of {@link MutableBasicGraph} that supports both directed and  * undirected graphs. Instances of this class should be constructed with {@link BasicGraphBuilder}.  *  *<p>Time complexities for mutation methods are all O(1) except for {@code removeNode(N node)},  * which is in O(d_node) where d_node is the degree of {@code node}.  *  * @author James Sexton  * @param<N> Node parameter type  */
end_comment

begin_class
DECL|class|ConfigurableMutableBasicGraph
specifier|final
class|class
...
name|backingGraph
decl_stmt|;
comment|/**    * Constructs a {@link MutableBasicGraph} with the properties specified in {@code builder}.    */
DECL|method|ConfigurableMutableBasicGraph (AbstractGraphBuilder<? super N> builder)
name|ConfigurableMutableBasicGraph
parameter_list|(
...
annotation|@
name|Override
DECL|method|edgeValueOrDefault (Object nodeA, Object nodeB, Presence defaultValue)
specifier|public
name|Presence
