...
return|;
block|}
comment|// TODO(b/31166974): If we add a Map of edgeValues, we can check against that for equality.
if|if
condition|(
name|graphA
operator|.
...
annotation|@
name|Override
DECL|method|edgeValueOrDefault (Object nodeU, Object nodeV, V defaultValue)
specifier|public
name|V
