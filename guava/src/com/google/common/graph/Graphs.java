...
return|;
block|}
comment|/**    * Returns true iff {@code graph1} and {@code graph2} have the same node and edge sets and    * each edge has the same source and target in both graphs.    *    * @see Graph#equals(Object)    */
DECL|method|equal ( @ullable DirectedGraph<?, ?> graph1, @Nullable DirectedGraph<?, ?> graph2)
specifier|public
specifier|static
parameter_list|<
name|N
...
return|;
block|}
comment|/**    * Returns true iff {@code graph1} and {@code graph2} have the same node and edge sets and    * each edge has the same incident node set in both graphs.    *    * @see Graph#equals(Object)    */
...
return|;
block|}
comment|/**    * Returns a string representation of {@code graph}, encoding the direction of each edge.    */
DECL|method|toString (final DirectedGraph<?, ?> graph)
specifier|public
specifier|static
name|String
name|toString
...
return|;
block|}
comment|/**    * Returns a string representation of {@code graph}, without regard to direction of edges.    */
DECL|method|toString (final Graph<?, ?> graph)
specifier|public
specifier|static
name|String
name|toString
