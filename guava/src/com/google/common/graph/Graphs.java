...
return|;
block|}
comment|/**    * Returns an unmodifiable view of edges that are parallel to {@code edge}, i.e. the set of edges    * that connect the same nodes in the same direction (if any). An edge is not parallel to itself.    *    * @throws IllegalArgumentException if {@code edge} is not present in {@code graph}    * @throws UnsupportedOperationException if {@code graph} is a {@link Hypergraph}    */
DECL|method|parallelEdges (final Graph<N, E> graph, final Object edge)
specifier|public
specifier|static
parameter_list|<
name|N
