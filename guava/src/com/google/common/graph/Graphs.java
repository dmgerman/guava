...
literal|"unchecked"
argument_list|)
DECL|method|copyOfInternal ( Graph<N> graph, GraphBuilder<N> copyBuilder, Predicate<? super N> nodePredicate)
specifier|private
specifier|static
parameter_list|<
name|N
...
control|)
block|{
comment|// TODO(b/28087289): Ensure that multiplicity is preserved if parallel edges are supported.
name|copy
operator|.
name|addEdge
argument_list|(
...
return|;
block|}
DECL|method|copyOfInternal ( Network<N, E> graph, NetworkBuilder<N, E> copyBuilder, Predicate<? super N> nodePredicate, Predicate<? super E> edgePredicate)
specifier|private
specifier|static
parameter_list|<
name|N
