...
condition|)
block|{
comment|// Use an optimized implementation for networks without parallel edges.
return|return
name|endpointsSimpleNetwork
argument_list|(
name|castToNetwork
argument_list|(
name|graph
...
return|;
block|}
DECL|method|endpointsSimpleNetwork (final Network<N, ?> graph)
specifier|private
specifier|static
parameter_list|<
name|N
...
return|;
block|}
comment|/**    * Returns a String of the endpoints for {@code graph}.    */
DECL|method|endpointsString (final Graph<N> graph)
specifier|private
specifier|static
parameter_list|<
name|N
...
return|;
block|}
comment|/**    * Returns a function that transforms an edge into a string representation of its endpoints    * in {@code graph}. The function's {@code apply} method will throw an    * {@link IllegalArgumentException} if {@code graph} does not contain {@code edge}.    */
DECL|method|edgeToEndpointsString (final Network<?, ?> graph)
specifier|private
specifier|static
name|Function
argument_list|<
...
return|;
block|}
DECL|method|allowsParallelEdges (Graph<?> graph)
specifier|private
specifier|static
name|boolean
name|allowsParallelEdges
...
literal|"unchecked"
argument_list|)
DECL|method|castToNetwork (Graph<N> graph)
specifier|private
specifier|static
parameter_list|<
name|N
