...
argument_list|>
block|{
comment|/**    * A placeholder for the (generally ignored) value type of a {@link BasicGraph}. Users shouldn't    * have to reference this enum unless they are implementing the {@link BasicGraph} interface.    */
DECL|enum|Presence
specifier|public
enum|enum
name|Presence
