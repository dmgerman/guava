...
parameter_list|)
function_decl|;
comment|/**    * Returns the hash code for this network. The hash code of a network is defined as the hash code    * of a map from each of the network's nodes to its outgoing edges.    *    *<p>A reference implementation of this is provided by {@link AbstractNetwork#hashCode()}.    */
annotation|@
name|Override
