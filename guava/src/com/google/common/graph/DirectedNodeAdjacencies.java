...
parameter_list|()
block|{
comment|// Don't simply use Sets.filter() or we'll end up with O(N) instead of O(1) size().
return|return
operator|new
name|AbstractSet
argument_list|<
...
block|}
block|}
DECL|method|isPredecessor (Object node)
specifier|private
name|boolean
name|isPredecessor
parameter_list|(
...
return|;
block|}
DECL|method|isSuccessor (Object node)
specifier|private
name|boolean
name|isSuccessor
parameter_list|(
