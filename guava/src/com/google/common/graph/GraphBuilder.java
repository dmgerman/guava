...
literal|null
decl_stmt|;
comment|// No default value to enforce that this is set before building
...
DECL|method|from (Graph<N, E> graph)
specifier|public
specifier|static
parameter_list|<
name|N
...
return|;
block|}
comment|/**    * This value should be set by {@link #directed()}, {@link #undirected()},    * or {@link #from(Graph)}.    */
DECL|method|directed (boolean directed)
specifier|private
name|GraphBuilder
argument_list|<
name|N
