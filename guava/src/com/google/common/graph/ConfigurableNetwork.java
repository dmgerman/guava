...
begin_comment
comment|/**  * Configurable implementation of {@link Network} that supports both directed and undirected graphs.  * Instances of this class should be constructed with {@link NetworkBuilder}.  *  *<p>Time complexities for mutation methods are all O(1) except for {@code removeNode(N node)},  * which is in O(d_node) where d_node is the degree of {@code node}.  *  * @author James Sexton  * @author Joshua O'Madadhain  * @author Omar Darwish  * @param<N> Node parameter type  * @param<E> Edge parameter type  */
end_comment
...
DECL|method|ConfigurableNetwork (NetworkBuilder<? super N, ? super E> builder, Map<N, NodeConnections<N, E>> nodeConnections, Map<E, N> edgeToReferenceNode)
name|ConfigurableNetwork
parameter_list|(
name|NetworkBuilder
argument_list|<
