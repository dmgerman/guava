...
begin_comment
comment|/**  * This class provides a skeletal implementation of {@link ValueGraph}. It is recommended to extend  * this class rather than implement {@link ValueGraph} directly, to ensure consistent {@link  * #equals(Object)} and {@link #hashCode()} results across different value graph implementations.  *  * @author James Sexton  * @param<N> Node parameter type  * @param<V> Value parameter type  * @since 20.0  */
end_comment
...
return|;
block|}
comment|/**    * Returns a string representation of this value graph.    */
annotation|@
name|Override
