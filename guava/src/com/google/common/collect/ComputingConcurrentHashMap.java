...
expr_stmt|;
block|}
DECL|method|compute (K key, int hash, CacheLoader<? super K, ? extends V> loader)
name|V
name|compute
parameter_list|(
name|K
...
literal|"serial"
argument_list|)
comment|// can never be serialized
DECL|class|AsynchronousExecutionException
specifier|static
specifier|final
class|class
...
name|ExecutionException
block|{
DECL|method|AsynchronousExecutionException (Throwable cause)
name|AsynchronousExecutionException
parameter_list|(
name|Throwable
name|cause
