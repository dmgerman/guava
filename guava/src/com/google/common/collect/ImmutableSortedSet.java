...
block|}
block|}
comment|/**    * Sorts and eliminates duplicates from the first {@code n} positions in {@code contents}.    * Returns the number of unique elements.  If this returns {@code k}, then the first {@code k}    * elements of {@code contents} will be the sorted, unique elements, and {@code    * contents[i] == null} for {@code k<= i< n}.    *    * @throws NullPointerException if any of the first {@code n} elements of {@code contents} is    *          null    */
DECL|method|sortAndUnique ( Comparator<? super E> comparator, int n, E... contents)
specifier|static
parameter_list|<
name|E
parameter_list|>
