...
parameter_list|)
block|{
comment|/*      * The comments for this method will use | to indicate the cut point and ( ) to indicate the      * bounds of ranges in the range map.      */
name|Entry
argument_list|<
name|Cut
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// Due to the splitting of any entries spanning the range bounds, we know that any entry with a
comment|// lower bound in the merge range is entirely contained by the merge range.
name|Set
argument_list|<
name|Entry
argument_list|<
...
argument_list|()
decl_stmt|;
comment|// Create entries mapping any unmapped ranges in the merge range to the specified value.
name|ImmutableMap
operator|.
name|Builder
argument_list|<
...
block|}
block|}
comment|// Remap all existing entries in the merge range.
specifier|final
name|Iterator
argument_list|<
name|Entry
...
argument_list|)
argument_list|,
literal|"Cannot merge range %s into a subRangeMap(%s)"
argument_list|,
name|range
argument_list|,
name|subRange
