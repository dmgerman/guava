...
begin_comment
comment|/**  * An implementation of {@code IRangeMap} based on a {@code TreeMap}, supporting  * all optional operations.  *  *<p>Like all {@code IRangeMap} implementations, this supports neither null  * keys nor null values.  *  * @author Louis Wasserman  */
end_comment
