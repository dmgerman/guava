...
literal|true
argument_list|)
DECL|class|HashMultimapGwtSerializationDependencies
specifier|abstract
class|class
...
argument_list|>
block|{
DECL|method|HashMultimapGwtSerializationDependencies (Map<K, Collection<V>> map)
name|HashMultimapGwtSerializationDependencies
parameter_list|(
name|Map
argument_list|<
