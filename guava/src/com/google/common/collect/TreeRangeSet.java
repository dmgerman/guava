...
return|;
block|}
comment|/**    * Returns a {@code TreeRangeSet} representing the union of the specified ranges.    *    *<p>This is the smallest {@code RangeSet} which encloses each of the specified ranges. An    * element will be contained in this {@code RangeSet} if and only if it is contained in at least    * one {@code Range} in {@code ranges}.    *    * @since 21.0    */
DECL|method|create (Iterable<Range<C>> ranges)
specifier|public
specifier|static
parameter_list|<
name|C
...
annotation|@
name|Override
DECL|method|intersects (Range<C> range)
specifier|public
name|boolean
name|intersects
parameter_list|(
