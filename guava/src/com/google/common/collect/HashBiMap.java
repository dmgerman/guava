...
literal|9
decl_stmt|;
comment|/**    * If hash flooding is detected, create this HashMap-backed implementation and forward all    * operations to it.    */
DECL|field|floodingDelegate
annotation|@
name|NullableDecl
annotation|@
name|VisibleForTesting
...
annotation|@
name|VisibleForTesting
DECL|method|switchToFloodProtection ()
name|void
name|switchToFloodProtection
parameter_list|()
block|{
...
argument_list|>
block|{
DECL|method|JdkBackedHashBiMap (int expectedSize)
name|JdkBackedHashBiMap
parameter_list|(
name|int
name|expectedSize
