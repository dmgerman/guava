...
block|}
block|}
DECL|method|fromSortedEntries ( Comparator<? super K> comparator, int size, Entry<K, V>[] entries)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
return|;
block|}
DECL|method|from ( ImmutableSortedSet<K> keySet, ImmutableList<V> valueList)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
return|;
block|}
DECL|method|fromEntries ( Comparator<? super K> comparator, boolean sameComparator, int size, Entry<K, V>... entries)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
return|;
block|}
DECL|method|sortEntries ( final Comparator<? super K> comparator, int size, Entry<K, V>[] entries)
specifier|private
specifier|static
parameter_list|<
name|K
...
expr_stmt|;
block|}
DECL|method|validateEntries (int size, Entry<K, V>[] entries, Comparator<? super K> comparator)
specifier|private
specifier|static
parameter_list|<
name|K
