...
name|hashCode
decl_stmt|;
DECL|method|RegularImmutableBiMap (TerminalEntry<?, ?>.... entriesToAdd)
name|RegularImmutableBiMap
parameter_list|(
name|TerminalEntry
argument_list|<
...
expr_stmt|;
block|}
comment|/**    * Constructor for RegularImmutableBiMap that takes as input an array of {@code TerminalEntry}    * entries.  Assumes that these entries have already been checked for null.    *     *<p>This allows reuse of the entry objects from the array in the actual implementation.    */
DECL|method|RegularImmutableBiMap (int n, TerminalEntry<?, ?>[] entriesToAdd)
name|RegularImmutableBiMap
parameter_list|(
name|int
name|n
...
expr_stmt|;
block|}
comment|/**    * Constructor for RegularImmutableBiMap that makes no assumptions about the input entries.    */
