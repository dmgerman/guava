...
DECL|method|containsKey (@ompatibleWithR) @heckForNull Object key)
name|boolean
name|containsKey
argument_list|(
annotation|@
...
DECL|method|containsEntry ( @ompatibleWithR) @heckForNull Object key, @CompatibleWith(R) @CheckForNull Object value)
name|boolean
name|containsEntry
argument_list|(
annotation|@
...
block|@
name|CanIgnoreReturnValue
DECL|method|remove ( @ompatibleWithR) @heckForNull Object key, @CompatibleWith(R) @CheckForNull Object value)
name|boolean
name|remove
argument_list|(
annotation|@
...
block|@
name|CanIgnoreReturnValue
DECL|method|removeAll (@ompatibleWithR) @heckForNull Object key)
name|Collection
argument_list|<
name|V
argument_list|>
