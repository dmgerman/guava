...
return|;
block|}
comment|/**    * A builder for immutable range sets. Duplicate or connected ranges are permitted, and will be    * merged in the resulting immutable range set.    */
DECL|class|Builder
specifier|public
specifier|static
class|class
...
expr_stmt|;
block|}
comment|/**      * Add the specified range to this builder. Duplicate or connected ranges are permitted, and      * will be merged in the resulting immutable range set.      */
DECL|method|add (Range<C> range)
specifier|public
name|Builder
argument_list|<
