...
return|;
block|}
DECL|method|asSet (DiscreteDomain<C> domain, Range<C> range)
name|ImmutableSortedSet
argument_list|<
name|C
argument_list|>
...
name|subRanges
decl_stmt|;
DECL|method|AsSet (DiscreteDomain<C> domain, Range<C> subRange, ImmutableList<Range<C>> subRanges)
name|AsSet
parameter_list|(
name|DiscreteDomain
argument_list|<
