...
expr_stmt|;
block|}
DECL|method|KeySet (int hashCode)
name|KeySet
parameter_list|(
name|int
name|hashCode
...
parameter_list|()
block|{
comment|// TODO(user): rewrite to delegate contains() calls to the KeySet
return|return
operator|new
...
parameter_list|()
block|{
comment|// TODO(user): rewrite to delegate contains() calls to the Values
return|return
operator|new
name|TransformedImmutableList
argument_list|<
...
name|map
decl_stmt|;
DECL|method|ValuesSerializedForm (ImmutableMap<?, V> map)
name|ValuesSerializedForm
parameter_list|(
name|ImmutableMap
argument_list|<
