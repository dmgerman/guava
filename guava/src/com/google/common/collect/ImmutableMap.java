...
literal|"unchecked"
argument_list|)
comment|// all entries will be Entry<K, V>'s
name|Entry
argument_list|<
name|K
argument_list|,
...
block|}
block|}
comment|// If the map is an EnumMap, it must have key type K for some<K extends Enum<K>>.
annotation|@
name|SuppressWarnings
argument_list|(
block|{
...
block|}
argument_list|)
DECL|method|copyOfEnumMapUnsafe (Map<? extends K, ? extends V> map)
specifier|private
specifier|static
parameter_list|<
name|K
