...
name|evictionListener
decl_stmt|;
DECL|method|EvictionToRemovalListener (MapEvictionListener<K, V> evictionListener)
specifier|public
name|EvictionToRemovalListener
parameter_list|(
name|MapEvictionListener
...
argument_list|()
decl_stmt|;
DECL|method|NullCache (MapMaker mapMaker, CacheLoader<? super K, V> loader)
name|NullCache
parameter_list|(
name|MapMaker
name|mapMaker
