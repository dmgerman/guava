...
function_decl|;
block|}
DECL|method|transformedEntryIterator ( Iterator<Map.Entry<K, V1>> entryIterator, final EntryTransformer<? super K, ? super V1, V2> transformer)
specifier|static
parameter_list|<
name|K
parameter_list|,
