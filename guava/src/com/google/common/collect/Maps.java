...
return|;
block|}
comment|/**    * {@code AbstractMap} substitute that caches all views.    */
annotation|@
name|GwtCompatible
...
argument_list|>
block|{
comment|// We deliberately don't extend AbstractMap to avoid the overhead of its view cache fields.
annotation|@
name|Override
DECL|method|size ()
specifier|public
