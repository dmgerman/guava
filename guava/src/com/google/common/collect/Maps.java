...
parameter_list|)
block|{
comment|// TODO(user): SortedSet, NavigableSet overloads
return|return
operator|new
name|AsMapView
argument_list|<
...
literal|"unchecked"
argument_list|)
comment|// unsafe, but Javadoc warns
name|K
name|k
init|=
operator|(
...
literal|"unchecked"
argument_list|)
comment|// known safe, since set contained it
name|K
name|k
init|=
operator|(
