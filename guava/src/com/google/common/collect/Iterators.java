...
argument_list|>
block|{
DECL|method|ConcatenatedIterator (Iterator<? extends Iterator<? extends T>> iterators)
specifier|public
name|ConcatenatedIterator
parameter_list|(
name|Iterator
...
annotation|@
name|Override
DECL|method|transform (Iterator<? extends T> iterator)
name|Iterator
argument_list|<
name|?
extends|extends
...
return|;
block|}
comment|/**      * Using the component iterators, rather than the input iterators directly,      * allows for higher performance in the case of nested concatenation.      */
DECL|method|getComponentIterators ( Iterator<? extends Iterator<? extends T>> iterators)
specifier|private
specifier|static
parameter_list|<
name|T
