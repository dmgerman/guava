...
argument_list|)
expr_stmt|;
comment|// TODO(user): retrofit once AbstractMultiset is updated to use the
comment|// new EntrySet skeleton
return|return
operator|new
...
block|}
block|}
DECL|method|elementSetImpl (final Multiset<E> multiset)
specifier|static
parameter_list|<
name|E
parameter_list|>
...
parameter_list|)
block|{
comment|// Some multisets support remove, but not setCount.
name|int
name|count
init|=
name|multiset
...
parameter_list|()
block|{
comment|// TODO(user): change this to multiset().clear() when it won't loop
comment|// back to itself
name|Iterator
argument_list|<
name|Entry
argument_list|<
