...
expr_stmt|;
block|}
comment|/**    * LinkedHashMultimap entries are in no less than three coexisting linked lists:    * a row in the hash table for a Set<V> associated with a key, the linked list    * of insertion-ordered entries in that Set<V>, and the linked list of entries    * in the LinkedHashMultimap as a whole.    */
...
name|valueHash
decl_stmt|;
DECL|field|nextInValueSetHashRow
annotation|@
name|Nullable
name|ValueEntry
argument_list|<
...
condition|)
block|{
comment|// first entry in the row
name|hashTable
index|[
name|row
index|]
