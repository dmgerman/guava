...
return|;
block|}
comment|// Returns total value strictly below the specified range.
DECL|method|totalTooLow ( BstAggregate<? super N> aggregate, GeneralRange<K> range, @Nullable N root)
specifier|private
specifier|static
parameter_list|<
name|K
...
annotation|@
name|Nullable
DECL|method|totalTooHigh ( BstAggregate<? super N> aggregate, GeneralRange<K> range, @Nullable N root)
specifier|private
specifier|static
parameter_list|<
name|K
