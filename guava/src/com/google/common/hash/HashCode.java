...
parameter_list|()
function_decl|;
comment|/**    * Creates a {@code HashCode} from a hexadecimal (base 16) encoded string. The string must be    * at least 2 characters long, and contain only valid, lower-cased hexadecimal characters.    *    * @since 15.0    */
