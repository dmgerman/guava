...
init|=
name|getDefaultStrategyFromSystemProperty
argument_list|()
decl_stmt|;
annotation|@
name|VisibleForTesting
DECL|field|USE_MITZ32_PROPERTY
specifier|static
specifier|final
name|String
name|USE_MITZ32_PROPERTY
init|=
literal|"com.google.common.hash.BloomFilter.useMitz32"
decl_stmt|;
annotation|@
name|VisibleForTesting
DECL|method|getDefaultStrategyFromSystemProperty ()
specifier|static
name|Strategy
name|getDefaultStrategyFromSystemProperty
parameter_list|()
