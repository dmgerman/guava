...
return|;
block|}
comment|/**    * Returns a {@link CharSource} that reads the given string value.    *    * @since 14.0    */
...
name|string
decl_stmt|;
DECL|method|StringCharSource (String string)
specifier|private
name|StringCharSource
parameter_list|(
name|String
...
DECL|method|asReader (final R readable)
specifier|static
parameter_list|<
name|R
extends|extends
...
return|;
block|}
DECL|method|asInputSupplier ( final CharSource source)
specifier|static
parameter_list|<
name|R
extends|extends
...
return|;
block|}
DECL|method|asOutputSupplier ( final CharSink sink)
specifier|static
parameter_list|<
name|W
extends|extends
...
return|;
block|}
DECL|method|asCharSource ( final InputSupplier<R> supplier)
specifier|static
parameter_list|<
name|R
extends|extends
...
return|;
block|}
DECL|method|asCharSink ( final OutputSupplier<W> supplier)
specifier|static
parameter_list|<
name|W
extends|extends
