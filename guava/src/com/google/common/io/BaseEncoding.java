...
parameter_list|)
function_decl|;
DECL|method|encodingStream (CharOutput charOutput)
specifier|abstract
name|ByteOutput
name|encodingStream
parameter_list|(
...
parameter_list|)
function_decl|;
DECL|method|decodingStream (CharInput charInput)
specifier|abstract
name|ByteInput
name|decodingStream
parameter_list|(
...
name|upperCase
decl_stmt|;
DECL|method|Alphabet (char[] chars)
name|Alphabet
parameter_list|(
name|char
index|[]
...
name|paddingChar
decl_stmt|;
DECL|method|StandardBaseEncoding (String alphabetChars, @Nullable Character paddingChar)
name|StandardBaseEncoding
parameter_list|(
name|String
name|alphabetChars
...
annotation|@
name|Override
DECL|method|encodingStream (final CharOutput out)
name|ByteOutput
name|encodingStream
parameter_list|(
specifier|final
...
annotation|@
name|Override
DECL|method|decodingStream (final CharInput reader)
name|ByteInput
name|decodingStream
parameter_list|(
specifier|final
...
block|}
block|}
DECL|method|ignoringInput (final CharInput delegate, final CharMatcher toIgnore)
specifier|static
name|CharInput
name|ignoringInput
parameter_list|(
...
return|;
block|}
DECL|method|separatingOutput ( final CharOutput delegate, final String separator, final int afterEveryChars)
specifier|static
name|CharOutput
name|separatingOutput
parameter_list|(
specifier|final
name|CharOutput
name|delegate
...
annotation|@
name|Override
DECL|method|encodingStream (final CharOutput output)
name|ByteOutput
name|encodingStream
parameter_list|(
specifier|final
...
annotation|@
name|Override
DECL|method|decodingStream (final CharInput input)
name|ByteInput
name|decodingStream
parameter_list|(
specifier|final
