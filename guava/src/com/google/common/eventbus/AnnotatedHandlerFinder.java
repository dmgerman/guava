...
block|{
comment|/**    * Returns all interfaces implemented by the class and all superclasses: all Classes that this is    * assignable to.    */
DECL|method|getAllSuperclasses (Class<?> clazz)
specifier|static
name|Set
argument_list|<
name|Class
