...
begin_comment
comment|/**  * GWT emulation of {@link ExplicitOrderedImmutableSortedSet}.  *  * @author Hayward Chan  */
end_comment
...
argument_list|>
block|{
DECL|method|ExplicitOrderedImmutableSortedSet (List<E> elements, Comparator<E> ordering)
name|ExplicitOrderedImmutableSortedSet
parameter_list|(
name|List
argument_list|<
