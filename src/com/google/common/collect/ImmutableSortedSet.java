...
return|;
default|default:
comment|/*          * We can't use Platform.clone() because of GWT bug 3621. See our GWT          * ImmutableSortedSetTest.testOf_gwtArraycopyBug() for details. We can't          * use System.arraycopy() here for the same reason.          */
name|Object
index|[]
name|array
init|=
...
block|}
block|}
comment|/** Sort the array, according to the comparator. */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
comment|// E comparator with Object array
DECL|method|sort ( Object[] array, Comparator<? super E> comparator)
specifier|private
specifier|static
parameter_list|<
name|E
...
expr_stmt|;
block|}
comment|/**    * Returns an array that removes duplicate consecutive elements, according to    * the provided comparator. Note that the input array is modified. This method    * does not support empty arrays.    */
DECL|method|removeDupes (Object[] array, Comparator<? super E> comparator)
specifier|private
specifier|static
parameter_list|<
name|E
...
return|;
block|}
comment|/** Simplified version of {@link Iterables#toArray} that is GWT safe. */
DECL|method|newObjectArray (Iterable<T> iterable)
specifier|private
specifier|static
parameter_list|<
name|T
