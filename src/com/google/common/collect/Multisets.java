...
begin_comment
comment|/**  * Provides static utility methods for creating and working with {@link  * Multiset} instances.  *  * @author Kevin Bourrillion  * @author Mike Bostock  * @author Louis Wasserman  * @since 2 (imported from Google Collections Library)  */
end_comment
...
block|}
block|}
comment|/**    * An implementation of {@link Multiset#elementSet}.    */
DECL|method|elementSetImpl (Multiset<E> self)
specifier|static
parameter_list|<
name|E
parameter_list|>
...
name|multiset
decl_stmt|;
DECL|method|ElementSetImpl (Multiset<E> multiset)
name|ElementSetImpl
parameter_list|(
name|Multiset
argument_list|<
