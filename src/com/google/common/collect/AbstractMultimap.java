...
DECL|method|AbstractMultimap (Map<K, Collection<V>> map)
specifier|protected
name|AbstractMultimap
parameter_list|(
name|Map
...
return|;
block|}
comment|/** Multiset view that stays in sync with the multimap keys. */
...
argument_list|>
block|{
DECL|method|remove (Object key, int occurrences)
annotation|@
name|Override
specifier|public
name|int
...
return|;
block|}
comment|/** Iterator across each key, repeating once per value. */
DECL|class|MultisetEntryIterator
specifier|private
class|class
name|MultisetEntryIterator
implements|implements
...
name|entry
decl_stmt|;
DECL|method|MultisetEntry (Map.Entry<K, Collection<V>> entry)
specifier|public
name|MultisetEntry
parameter_list|(
name|Map
...
block|}
comment|/** Iterator across each key, repeating once per value. */
DECL|class|MultisetKeyIterator
specifier|private
class|class
name|MultisetKeyIterator
implements|implements
...
return|;
block|}
comment|// The following methods are included to improve performance.
DECL|method|clear ()
annotation|@
name|Override
specifier|public
...
block|}
block|}
comment|/** Iterator across all values. */
...
name|entries
decl_stmt|;
comment|// TODO: should we copy this javadoc to each concrete class, so that classes
comment|// like LinkedHashMultimap that need to say something different are still
comment|// able to {@inheritDoc} all the way from Multimap?
...
parameter_list|()
block|{
comment|// TODO: can we refactor so we're not doing "this instanceof"?
return|return
operator|(
name|this
operator|instanceof
...
block|}
block|}
comment|/** Entry set for a {@link SetMultimap}. */
DECL|class|EntrySet
specifier|private
class|class
name|EntrySet
