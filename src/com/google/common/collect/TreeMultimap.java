...
return|;
block|}
comment|// Used by the TreeMultimap serialization test.
DECL|method|TreeMultimap ()
name|TreeMultimap
parameter_list|()
block|{
name|this
...
expr_stmt|;
block|}
comment|// Must be package-private so multimaps with null comparators can be
comment|// serialized (which can be created with Multimaps.newTreeMultimap()). Once
comment|// that method is removed, this constructor can be made private.
DECL|method|TreeMultimap (@ullable Comparator<? super K> keyComparator, @Nullable Comparator<? super V> valueComparator)
name|TreeMultimap
parameter_list|(
annotation|@
name|Nullable
