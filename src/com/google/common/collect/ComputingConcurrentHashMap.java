...
comment|// computation began, but by now that entry may have been
comment|// replaced. Find the current entry, and pass it to
comment|// recordWrite to ensure that the eviction lists are
comment|// consistent with the current map entries.
name|segment
operator|.
name|recordWrite
argument_list|(
...
block|{
comment|// avoid creating a new value reference pointing back to a
comment|// disconnected entry
name|setValueReference
argument_list|(
name|liveValueReference
argument_list|)
