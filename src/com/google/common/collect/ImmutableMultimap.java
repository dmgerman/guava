...
decl_stmt|;
block|}
comment|/**    * Multimap for {@link ImmutableMultimap.Builder} that sorts key and allows    * duplicate values,    */
...
return|;
block|}
comment|/**      * Specifies the ordering of the generated multimap's keys.      *       * @since 8      */
annotation|@
name|Beta
...
return|;
block|}
comment|/**      * Specifies the ordering of the generated multimap's values for each key.      *       * @since 8      */
annotation|@
name|Beta
