...
parameter_list|()
block|{}
comment|/**    * Returns the backing delegate instance that methods are forwarded to.    * Abstract subclasses generally override this method with an abstract method    * that has a more specific return type, such as {@link    * ForwardingSet#delegate}. Concrete subclasses override this method to supply    * the instance being decorated.    */
...
parameter_list|()
function_decl|;
comment|/**    * Returns the string representation generated by the delegate's    * {@code toString} method.    */
...
return|;
block|}
comment|/* No equals or hashCode. See class comments for details. */
block|}
end_class
