...
DECL|method|valueReclaimed (ValueReference<K, V> valueReference)
name|void
name|valueReclaimed
parameter_list|(
name|ValueReference
...
annotation|@
name|Override
DECL|method|valueReclaimed (ValueReference<Object, Object> v)
specifier|public
name|void
name|valueReclaimed
parameter_list|(
...
condition|)
block|{
comment|// value was garbage collected
name|enqueueNotification
argument_list|(
name|key
argument_list|,
