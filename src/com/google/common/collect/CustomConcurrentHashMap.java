...
argument_list|()
expr_stmt|;
comment|// valueReclaimed will add to evictionNotificationQueue
block|}
DECL|method|copyFor (ReferenceEntry<K, V> entry)
specifier|public
name|ValueReference
...
condition|)
block|{
comment|// entry was removed from map, so can't be reused
name|evictionNotificationQueue
operator|.
name|offer
argument_list|(
...
block|}
comment|/**    * Returns true if the given entry has expired.    */
DECL|method|isExpired (ReferenceEntry<K, V> expirable, long now)
name|boolean
name|isExpired
parameter_list|(
name|ReferenceEntry
...
literal|"Segment.this"
argument_list|)
DECL|method|addExpirable (ReferenceEntry<K, V> expirable)
name|void
name|addExpirable
parameter_list|(
name|ReferenceEntry
...
expr_stmt|;
block|}
DECL|method|recordExpirationTime (ReferenceEntry<K, V> expirable, long expirationNanos)
name|void
name|recordExpirationTime
parameter_list|(
name|ReferenceEntry
...
literal|"Segment.this"
argument_list|)
DECL|method|removeExpirable (ReferenceEntry<K, V> expirable)
name|void
...
literal|"Segment.this"
argument_list|)
DECL|method|inExpirationList (ReferenceEntry<K, V> expirable)
name|boolean
name|inExpirationList
parameter_list|(
name|ReferenceEntry
...
literal|"Segment.this"
argument_list|)
DECL|method|addEvictable (ReferenceEntry<K, V> evictable)
name|void
name|addEvictable
parameter_list|(
name|ReferenceEntry
...
literal|"Segment.this"
argument_list|)
DECL|method|removeEvictable (ReferenceEntry<K, V> evictable)
name|void
...
literal|"Segment.this"
argument_list|)
DECL|method|inEvictionList (ReferenceEntry<K, V> evictable)
name|boolean
name|inEvictionList
parameter_list|(
name|ReferenceEntry
...
literal|"Segment.this"
argument_list|)
DECL|method|clearEvictionQueue ()
name|void
...
condition|)
block|{
comment|// value was garbage collected; copy entry for notification
name|ReferenceEntry
argument_list|<
name|K
argument_list|,
...
block|}
block|}
comment|// Note, this method should only be called when it is impossible to reuse
comment|// an entry. Currently this only occurs when its key is garbage collected.
...
return|;
block|}
DECL|method|invalidateValue (ReferenceEntry<K, V> entry, int hash, ValueReference<K, V> valueReference)
name|boolean
...
literal|"Segment.this"
argument_list|)
DECL|method|enqueueCleanup (ReferenceEntry<K, V> entry)
name|void
name|enqueueCleanup
parameter_list|(
name|ReferenceEntry
