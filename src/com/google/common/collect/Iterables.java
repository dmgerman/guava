...
return|;
block|}
comment|/**    * Returns {@code true} if {@code iterable} contains {@code element}; that is,    * any object for while {@code equals(element)} is true.    */
...
comment|// Note: hand-written GWT-compatible version of
comment|// list.subList(to, list.size()).clear();
name|ListIterator
argument_list|<
name|T
argument_list|>
