...
block|}
block|}
DECL|method|sanityCheckIPv4String (String ipv4String)
specifier|private
specifier|static
name|boolean
name|sanityCheckIPv4String
parameter_list|(
name|String
name|ipv4String
parameter_list|)
...
literal|"sunapi"
argument_list|)
comment|// sun.net.util.IPAddressUtil
...
condition|)
block|{
comment|// Failed extra IPv4 string literal sanity checks.
comment|// Let the "addr == null" check below throw the exception.
name|addr
operator|=
literal|null
expr_stmt|;
