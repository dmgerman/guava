...
begin_comment
comment|/**  * A callback interface to process bytes from a stream.  *  *<p>{@link #processBytes} will be called for each line that is read, and  * should return {@code false} when you want to stop processing.  *  * @author Chris Nokleberg  * @since Guava release 01  */
end_comment
