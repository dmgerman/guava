...
begin_comment
comment|/**  * Provides utility methods for working with files.  *  *<p>All method parameters must be non-null unless documented otherwise.  *  * @author Chris Nokleberg  * @since 9.09.15<b>tentative</b>  */
end_comment
...
block|}
block|}
comment|/**    * Deletes all the files within a directory. Does not delete the    * directory itself.    *    *<p>If the file argument is a symbolic link this method will do    * nothing. Symbolic links within the directory are not followed.    *    * @param directory the directory to delete the contents of    * @throws IllegalArgumentException if the argument is not a directory    * @throws IOException if an I/O error occurs    * @see #deleteRecursively    */
...
return|;
block|}
comment|/**    * Process the bytes of a file.    *    * @param file the file to read    * @param processor the object to which to pass the bytes of the file    * @return the result of the byte processor    * @throws IOException if an I/O error occurs    */
