...
comment|// Package private for GWT serialization.
DECL|enum|AlwaysFalsePredicate
enum|enum
name|AlwaysFalsePredicate
implements|implements
name|Predicate
...
name|components
decl_stmt|;
DECL|method|AndPredicate (Iterable<? extends Predicate<? super T>> components)
specifier|private
name|AndPredicate
parameter_list|(
name|Iterable
...
literal|1
decl_stmt|;
comment|/* Start with all bits on. */
for|for
control|(
name|Predicate
argument_list|<
...
name|components
decl_stmt|;
DECL|method|OrPredicate (Iterable<? extends Predicate<? super T>> components)
specifier|private
name|OrPredicate
parameter_list|(
name|Iterable
...
literal|0
decl_stmt|;
comment|/* Start with all bits off. */
for|for
control|(
name|Predicate
argument_list|<
...
decl_stmt|;
block|}
comment|/**    * Determines whether the two Iterables contain equal elements. More    * specifically, this method returns {@code true} if {@code iterable1} and    * {@code iterable2} contain the same number of elements and every element of    * {@code iterable1} is equal to the corresponding element of {@code    * iterable2}.    *    *<p>This is not a general-purpose method; it assumes that the iterations    * contain no {@code null} elements.    */
DECL|method|iterableElementsEqual ( Iterable<?> iterable1, Iterable<?> iterable2)
specifier|private
specifier|static
name|boolean
name|iterableElementsEqual
