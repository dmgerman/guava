...
annotation|@
name|Override
DECL|method|equivalent (@ullable Iterable<T> iterableA, @Nullable Iterable<T> iterableB)
specifier|public
name|boolean
name|equivalent
parameter_list|(
...
annotation|@
name|Override
DECL|method|hash (@ullable Iterable<T> iterable)
specifier|public
name|int
name|hash
parameter_list|(
