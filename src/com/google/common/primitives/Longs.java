...
begin_comment
comment|/**  * Static utility methods pertaining to {@code long} primitives, that are not  * already found in either {@link Long} or {@link Arrays}.  *  * @author Kevin Bourrillion  * @since 1  */
end_comment
...
return|;
block|}
comment|/**    * Returns the {@code long} value whose byte representation is the given 8    * bytes, in big-endian order; equivalent to {@code Longs.fromByteArray(new    * byte[] {b1, b2, b3, b4, b5, b6, b7, b8})}.    *    * @since 7    */
annotation|@
name|GwtIncompatible
argument_list|(
literal|"doesn't work"
