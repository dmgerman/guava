...
return|;
block|}
comment|/**    * Returns the {@code char} value whose byte representation is the given 2    * bytes, in big-endian order; equivalent to {@code Chars.fromByteArray(new    * byte[] {b1, b2})}.    *    * @since Guava release 07    */
annotation|@
name|GwtIncompatible
argument_list|(
literal|"doesn't work"
