...
begin_comment
comment|/**  * Static utility methods pertaining to {@code char} primitives, that are not  * already found in either {@link Character} or {@link Arrays}.  *  * @author Kevin Bourrillion  * @since 9.09.15<b>tentative</b>  */
end_comment
...
return|;
block|}
comment|/**    * Copies a collection of {@code Character} instances into a new array of    * primitive {@code char} values.    *    * @param collection a collection of {@code Character} objects    * @return an array containing the same values as {@code collection}, in the    *     same order, converted to primitives    * @throws NullPointerException if {@code collection} or any of its elements    *     is null    */
