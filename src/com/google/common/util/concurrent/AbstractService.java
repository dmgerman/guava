...
name|failureCause
decl_stmt|;
DECL|method|transitionSucceeded (State result)
name|void
name|transitionSucceeded
parameter_list|(
name|State
...
parameter_list|)
block|{
comment|// guarded by AbstractService.lock
name|checkState
argument_list|(
name|this
operator|.
...
expr_stmt|;
block|}
DECL|method|transitionFailed (Throwable cause)
name|void
name|transitionFailed
parameter_list|(
name|Throwable
