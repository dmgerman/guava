...
parameter_list|)
block|{
comment|// TODO: Do we want to leave these Precondition checks in here?
...
return|;
block|}
comment|/**    * Returns a new thread factory using the options supplied during the building    * process.    *    * @return the fully constructed {@link ThreadFactory}    */
DECL|method|build ()
specifier|public
name|ThreadFactory
name|build
