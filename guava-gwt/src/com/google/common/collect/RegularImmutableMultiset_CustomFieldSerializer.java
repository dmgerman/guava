...
begin_class
DECL|class|RegularImmutableMultiset_CustomFieldSerializer
specifier|public
class|class
...
argument_list|)
expr_stmt|;
comment|/*      * For this custom field serializer to be invoked, the set must have been      * RegularImmutableMultiset before it's serialized. Since      * RegularImmutableMultiset always have one or more elements,      * ImmutableMultiset.copyOf always return a RegularImmutableMultiset back.      */
return|return
operator|(
name|RegularImmutableMultiset
argument_list|<
