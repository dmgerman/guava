...
begin_comment
comment|/**  * This class implements the GWT serialization of {@link JdkBackedImmutableMultiset}.  *  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|JdkBackedImmutableMultiset_CustomFieldSerializer
specifier|public
class|class
name|JdkBackedImmutableMultiset_CustomFieldSerializer
block|{
DECL|method|deserialize (SerializationStreamReader reader, ImmutableMultiset<?> instance)
specifier|public
specifier|static
name|void
name|deserialize
...
return|;
block|}
DECL|method|serialize (SerializationStreamWriter writer, ImmutableMultiset<?> instance)
specifier|public
specifier|static
name|void
name|serialize
