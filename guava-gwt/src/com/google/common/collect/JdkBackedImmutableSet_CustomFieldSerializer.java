...
begin_comment
comment|/**  * This class implements the GWT serialization of {@link JdkBackedImmutableSet}.  *  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|JdkBackedImmutableSet_CustomFieldSerializer
specifier|public
class|class
name|JdkBackedImmutableSet_CustomFieldSerializer
block|{
DECL|method|deserialize (SerializationStreamReader reader, ImmutableSet<?> instance)
specifier|public
specifier|static
name|void
name|deserialize
...
return|;
block|}
DECL|method|serialize (SerializationStreamWriter writer, ImmutableSet<?> instance)
specifier|public
specifier|static
name|void
name|serialize
