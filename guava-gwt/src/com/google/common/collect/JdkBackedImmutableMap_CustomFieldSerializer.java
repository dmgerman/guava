...
begin_comment
comment|/**  * This class implements the GWT serialization of {@link JdkBackedImmutableMap}.  *  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|JdkBackedImmutableMap_CustomFieldSerializer
specifier|public
class|class
name|JdkBackedImmutableMap_CustomFieldSerializer
block|{
DECL|method|deserialize (SerializationStreamReader reader, ImmutableMap<?, ?> instance)
specifier|public
specifier|static
name|void
name|deserialize
...
return|;
block|}
DECL|method|serialize (SerializationStreamWriter writer, ImmutableMap<?, ?> instance)
specifier|public
specifier|static
name|void
name|serialize
