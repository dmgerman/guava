...
begin_comment
comment|/**  * This class implements the GWT serialization of {@link JdkBackedImmutableBiMap}.  *  * @author Louis Wasserman  */
end_comment

begin_class
DECL|class|JdkBackedImmutableBiMap_CustomFieldSerializer
specifier|public
class|class
name|JdkBackedImmutableBiMap_CustomFieldSerializer
block|{
DECL|method|deserialize (SerializationStreamReader reader, ImmutableBiMap<?, ?> instance)
specifier|public
specifier|static
name|void
name|deserialize
...
return|;
block|}
DECL|method|serialize (SerializationStreamWriter writer, ImmutableBiMap<?, ?> instance)
specifier|public
specifier|static
name|void
name|serialize
