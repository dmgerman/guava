...
return|;
block|}
comment|/**    * Returns a {@code MapSplitter} which splits entries based on this splitter,    * and splits entries into keys and values using the specified separator.    *    * @since Guava release 10    */
annotation|@
name|CheckReturnValue
annotation|@
name|Beta
...
return|;
block|}
comment|/**    * Returns a {@code MapSplitter} which splits entries based on this splitter,    * and splits entries into keys and values using the specified key-value    * splitter.    *    * @since Guava release 10    */
annotation|@
name|CheckReturnValue
annotation|@
name|Beta
...
return|;
block|}
comment|/**    * An object that splits strings into maps as {@code Splitter} splits    * iterables and lists. Like {@code Splitter}, it is thread-safe and    * immutable.    *    * @since Guava release 10    */
annotation|@
name|Beta
