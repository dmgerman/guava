...
expr_stmt|;
block|}
DECL|method|MediaType (String type, String subtype)
specifier|private
name|MediaType
parameter_list|(
name|String
...
return|;
block|}
comment|/**    * Creates a new media type with the given type and subtype.    *    * @throws IllegalArgumentException if type or subtype is invalid    */
