...
name|computer
decl_stmt|;
DECL|method|ExpiringComputingMap (long expirationMillis, int initialCapacity)
name|ExpiringComputingMap
parameter_list|(
name|long
name|expirationMillis
...
expr_stmt|;
block|}
DECL|method|ExpiringComputingMap ( long expirationMillis, Function<? super K, ? extends V> computer, int initialCapacity)
name|ExpiringComputingMap
parameter_list|(
name|long
name|expirationMillis
