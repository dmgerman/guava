...
begin_comment
comment|/**  * GWT emulation of {@code HashBiMap} that just delegates to a LinkedHashMap and a HashMap.  *  * @author Mike Bostock  */
end_comment
...
parameter_list|()
block|{
comment|// we only care about the forward-direction order, so only that direction needs to be an LHM
name|super
argument_list|(
operator|new
name|LinkedHashMap
