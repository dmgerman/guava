...
begin_comment
comment|/**  * Static utility methods pertaining to {@link Map} instances. Also see this  * class's counterparts {@link Lists} and {@link Sets}.  *  * @author Kevin Bourrillion  * @author Mike Bostock  * @author Isaac Shum  * @author Louis Wasserman  * @since Guava release 02 (imported from Google Collections Library)  */
end_comment
...
return|;
block|}
DECL|method|mapDifference (boolean areEqual, Map<K, V> onlyOnLeft, Map<K, V> onlyOnRight, Map<K, V> onBoth, Map<K, ValueDifference<V>> differences)
specifier|private
specifier|static
parameter_list|<
name|K
...
DECL|method|add (Entry<K, V> element)
annotation|@
name|Override
specifier|public
name|boolean
...
throw|;
block|}
DECL|method|addAll ( Collection<? extends Entry<K, V>> collection)
annotation|@
name|Override
specifier|public
name|boolean
...
return|;
block|}
comment|// The overrides of remove(), removeAll(), and retainAll() in EntrySet and
comment|// Values are needed when the backing map views have iterators that don't
comment|// support remove().
comment|// TODO(jlevy): See if similar logic is needed elsewhere.
DECL|class|EntrySet
class|class
name|EntrySet
extends|extends
...
name|delegate
decl_stmt|;
DECL|method|Values (Collection<V2> delegate)
specifier|public
name|Values
parameter_list|(
name|Collection
...
block|}
block|}
comment|/**    * An implementation of {@link Map#entrySet}.    */
DECL|method|entrySetImpl ( Map<K, V> map, Supplier<Iterator<Entry<K, V>>> entryIteratorSupplier)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
name|map
decl_stmt|;
DECL|field|entryIteratorSupplier
specifier|private
specifier|final
name|Supplier
argument_list|<
...
block|}
block|}
comment|/**    * An implementation of {@link Map#keySet}.    */
DECL|method|keySetImpl (final Map<K, V> map)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
return|;
block|}
comment|/**    * An implementation of {@link Map#values}.    */
DECL|method|valuesImpl (Map<K, V> map)
specifier|static
parameter_list|<
name|K
parameter_list|,
...
return|;
block|}
comment|/**    * A wrapper on a map that supplies the {@code ImprovedAbstractMap}    * implementations of {@code keySet()} and {@code values()}.    */
DECL|class|AbstractMapWrapper
specifier|private
specifier|static
specifier|final
class|class
...
name|map
decl_stmt|;
DECL|method|AbstractMapWrapper (Map<K, V> map)
name|AbstractMapWrapper
parameter_list|(
name|Map
argument_list|<
