...
return|;
block|}
comment|/**    *<b>Deprecated.</b>    *    * @deprecated use {@link #uniqueIndex(Iterator, Function)} by casting    * {@code values} to an {@code Iterator}, or better by implementing only    * {@code Iterator} and not {@code Iterable}.    */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
argument_list|>
parameter_list|>
DECL|method|uniqueIndex ( I values, Function<? super V, K> keyFunction)
name|ImmutableMap
argument_list|<
name|K
argument_list|,
